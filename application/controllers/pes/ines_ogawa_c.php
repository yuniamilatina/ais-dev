...
class ines_ogawa_c extends CI_Controller
{
    ...
    {
        $data['work_center'] = $work_center;
        $this->load->view('pes/ines_ogawa_v', $data);
    }
    ...
    public function insertTpr()
    {
        ...
        if ($exist == 0) {
            ...
            $this->dandori_board_m->update_dandori_board($prod_order_no, $work_center, $part_no);
            $this->dandori_board_m->generateCheckPointDandori($prod_order_no, $work_center, $part_no);
        }
    ...
    public function stopSetupChute()
    {
        ...
        $this->setup_chute_m->update_setup_chute_not_use($work_center, $prod_order_no);
