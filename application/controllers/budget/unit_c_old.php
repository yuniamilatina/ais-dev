...
class unit_c extends CI_Controller {
    ...
    function create_unit() {
        ...
        $data['content'] = 'budget/unit/create_unit_v';
    ...
    function save_unit() {
        ...
        $this->form_validation->set_rules('CHR_UNIT', 'Unit', 'required|min_length[1]|max_length[3]|callback_check_id|trim');
        $this->form_validation->set_rules('CHR_UNIT_DESC', 'Unit Description', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->log_m->add_log('33', $data['INT_ID_SATUAN']);
    ...
    function edit_unit($id) {
        ...
        $data['title'] = 'Edit UOM';
        $data['content'] = 'budget/unit/edit_unit_v';
        $this->load->view($this->layout, $data);
    }
