...
class subsection_c extends CI_Controller {
    ...
    private $back_to_manage = 'edoc/subsection_c/index/';
    ...
    function index($msg = NULL , $id_section) {
        ...
        $data['content'] = 'edoc/subsection/manage_subsection_v';
    ...
    function myIndex($id) {
        ...
        $data['msg'] = $msg;
        $data['data'] = $this->subsection_m->get_subsection_by_id_section($id);
		$data['data_id_section'] = $id;
    ...
    function create_subsection($id_section) {
        ...
        $data['data_id_section'] = $id_section;
		$data['data_name_section'] = $this->section_m->get_name_section($id_section);
        $data['content'] = 'edoc/subsection/create_subsection_v';
    ...
    function edit_subsection($id_subsection) {
		...
		$data['data_name_section'] = $this->section_m->get_name_section($id_section);
		$data['data_section'] = $this->section_m->get_section();		
        $data['content'] = 'edoc/subsection/edit_subsection_v';
