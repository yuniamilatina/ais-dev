...
class section_c extends CI_Controller {
    ...
    private $back_to_manage = 'edoc/section_c/index/';
    private $role = 6;
    ...
    function index($msg = NULL) {
        ...
        $data['msg'] = $msg;
        $data['data'] = $this->section_m->get_section_a();
        $data['content'] = 'edoc/section/manage_section_v';
    ...
    function create_section() {
        ...
        $data['content'] = 'edoc/section/create_section_v';
    ...
    function edit_section($id) {
        $this->role_module_m->authorization('65');
        $data['data'] = $this->section_m->get_data_section($id)->row();
        $data['content'] = 'edoc/section/edit_section_v';
        $data['data_dept'] = $this->dept_m->get_dept();
        $data['data_costcenter'] = $this->costcenter_m->get_costcenter();
