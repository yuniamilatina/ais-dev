<?php
	...
	* 
	*/
	class approval_register_manager_c extends CI_Controller
	{
		
		private $layout = '/template/head';
	    private $back_to_manage = 'efila/approval_register_manager_c/index/';
	    ...
	    function index($msg = NULL) {
	        ...
	        $data['msg'] = $msg;
	        $data['data'] = $this->approval_register_document_m->get_register_manager();
	        $data['content'] = 'efila/approval_manager/approval_register_v';
	        $data['title'] = 'Approval Register Document';
	        $data['news'] = $this->news_m->get_news();
	        $data['app'] = $this->role_module_m->get_app();
	        $data['module'] = $this->role_module_m->get_module();
	        $data['function'] = $this->role_module_m->get_function();
	        $data['sidebar'] = $this->role_module_m->side_bar(266);
	    ...
	    function detail_register($id) {
	        ...
	        $data['content'] = 'efila/approval_manager/register_detail_v';
	    ...
	    //updating data
	    function update_approval_manager($status, $id = NULL) {
	        $msg = 2;
	        ...
	        $maxid = $maxid + 1;
	        $npk = "";
	        $npkk = $this->approval_register_document_m->get_npk_gm();
	        foreach ($npkk as $key) {
	        	$npk = $key->CHR_NPK;
	        }
	        $dept = "";
			...
			if($this->input->post('CHR_INFO')) {
	            ...
	            $data1 = array(
	        		...
	        		'CHR_NOTIF_DESC' => "New Register Document Rejected By Manager",
		        ...
		        if($cat != 'STD'){
			        $data1 = array(
		        		...
		        		'CHR_LINK' => "efila/approval_register_gm_c",
		        		'CHR_CREATED_BY' => "EFILA ".$dept,
		        		'CHR_CREATED_DATE' => $tgl,
		        		'CHR_CREATED_TIME' => $time
			        );
            ...
            redirect('efila/approval_register_manager_c/index/'. $msg);					
	    }
