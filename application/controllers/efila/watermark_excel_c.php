...
class PDF extends PDF_Rotate {
    ...
    function Header() {
        ...
        $this->RotatedText(70, 245, 'Uncontrolled Copy', 0);
        ...
        $this->SetTextColor(179, 102, 255);
        $this->RotatedText(70, 255, 'EFILA Document System', 0);
...
ob_end_clean();
$pdf->Output("/var/www/aisin-web/AIS_PP/assets/Document/Master_list/".$no_doc.".pdf", 'F'); //If you Leave blank then it should take default "I" i.e. Browser
