<?php
	...
	* 
	*/
	class approval_revision_manager_c extends CI_Controller
	{
		
		private $layout = '/template/head';
	    private $back_to_manage = 'efila/approval_revision_manager_c/index/';
	    ...
	    function index($msg = NULL) {
	        ...
	        $data['msg'] = $msg;
	        $data['data'] = $this->approval_revision_document_m->get_revision_manager();
	        $data['content'] = 'efila/approval_manager/approval_revision_v';
	        $data['title'] = 'Approval Revision Document';
	        $data['news'] = $this->news_m->get_news();
	        $data['app'] = $this->role_module_m->get_app();
	        $data['module'] = $this->role_module_m->get_module();
	        $data['function'] = $this->role_module_m->get_function();
	        $data['sidebar'] = $this->role_module_m->side_bar(267);
	    ...
	    function detail_revision($id) {
	        ...
	        $data['content'] = 'efila/approval_manager/revision_detail_v';
	    ...
	    function update_approval_manager($status, $id = NULL) {
	        ...
	        $maxid = $maxid + 1;
	        $npk = "";
	        $npkk = $this->approval_revision_document_m->get_npk_gm();
	        foreach ($npkk as $key) {
	        	$npk = $key->CHR_NPK;
	        }
	        $dept = "";
			...
			if($this->input->post('CHR_INFO')) {
	            ...
	            $data1 = array(
	        		...
	        		'CHR_NOTIF_DESC' => "ReviSion Document Rejected By Manager",
		        ...
		        if($cat != 'STD'){
			        $data1 = array(
		        		...
		        		'CHR_LINK' => "efila/approval_revision_gm_c",
		        		'CHR_CREATED_BY' => "EFILA ".$dept,
		        		'CHR_CREATED_DATE' => $tgl,
		        		'CHR_CREATED_TIME' => $time
			        );
            ...
            redirect('efila/approval_revision_manager_c/index/'. $msg);					
	    }
