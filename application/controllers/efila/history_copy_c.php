<?php
	...
	* 
	*/
	class history_copy_c extends CI_Controller
	{
		
		private $layout = '/template/head';
	    private $back_to_manage = 'efila/history_copy_c/index/';

	    public function __construct() {
	        parent::__construct();
	        $this->load->model('efila/history_copy_m');
	    ...
	    function index($msg = NULL) {
	        ...
	        $data['msg'] = $msg;
	        $data['data'] = $this->history_copy_m->get_history_copy();
	        $data['content'] = 'efila/history_copy/history_copy_v';
	        $data['title'] = 'History Copy';
	        $data['news'] = $this->news_m->get_news();
	        $data['app'] = $this->role_module_m->get_app();
	        $data['module'] = $this->role_module_m->get_module();
	        $data['function'] = $this->role_module_m->get_function();
	        $data['sidebar'] = $this->role_module_m->side_bar(280);
