<?php
	...
	* 
	*/
	class approval_copy_msu_c extends CI_Controller
	{
		
		private $layout = '/template/head';
	    private $back_to_manage = 'efila/approval_copy_msu_c/index/';
	    ...
	    function index($msg = NULL) {
	        ...
	        $data['msg'] = $msg;
	        $data['data'] = $this->approval_copy_document_m->get_copy_msu();
	        $data['content'] = 'efila/approval_msu/approval_copy_v';
	        $data['title'] = 'Approval Copy Document';
	        $data['news'] = $this->news_m->get_news();
	        $data['app'] = $this->role_module_m->get_app();
	        $data['module'] = $this->role_module_m->get_module();
	        $data['function'] = $this->role_module_m->get_function();
	        $data['sidebar'] = $this->role_module_m->side_bar(275);
	    ...
	    function detail_copy($id) {
	        ...
	        $data['content'] = 'efila/approval_msu/copy_detail_v';
	    ...
	    function update_approval_msu($status, $id = NULL, $iddoc = NULL) {
			...
			if($this->input->post('CHR_INFO')) {
	            ...
	            $data1 = array(
	        		...
	        		'CHR_NOTIF_DESC' => "Copy Document Rejected By MSU",
		        ...
		        $cate = $this->approval_copy_document_m->get_cat_name($id);
		        $cat = "";
		        foreach ($cate as $key) {
		        ...
		        $data1 = array(
		        	...
		        	'CHR_NPK' => $npk,
		        	'INT_ID_APP' => 36,
		        	'CHR_NOTIF_TITLE' => "Copy Document Approved",
	        		'CHR_NOTIF_DESC' => "Copy Document Approved",
	        		'CHR_LINK' => "efila/copy_document_c",
	        		'CHR_CREATED_BY' => "EFILA ".$dept,
	        		'CHR_CREATED_DATE' => $tgl,
	        		'CHR_CREATED_TIME' => $time
				...
				rename(DOCROOT.'/assets/Document/Master_list/Original_file/'.$document, DOCROOT.'/assets/Document/Copy/'.$document);
	            $data1 = array(
            ...
            redirect('efila/approval_copy_msu_c/index/'. $msg);					
	    }
