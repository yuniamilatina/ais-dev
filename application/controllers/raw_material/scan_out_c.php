...
class scan_out_c extends CI_Controller {
    ...
    public function index($start_date = null, $finish_date = null) {
        ...
        $data['content'] = 'raw_material/report_scan_out_raw_material_v';
        $data['title'] = 'Scan Out';
        $data['app'] = $this->role_module_m->get_app();
        $data['module'] = $this->role_module_m->get_module();
        $data['function'] = $this->role_module_m->get_function();
        $data['sidebar'] = $this->role_module_m->side_bar(115);
    ...
    public function summary($start_date = null, $finish_date = null) {
        ...
        $data['start_date'] = date("d-m-Y", strtotime($start_date));
        $data['finish_date'] = date("d-m-Y", strtotime($finish_date));
        $data['content'] = 'raw_material/report_scan_out_summary_raw_material_v';
        $data['title'] = 'Scan Out Summary';
        $data['app'] = $this->role_module_m->get_app();
        $data['module'] = $this->role_module_m->get_module();
        $data['function'] = $this->role_module_m->get_function();
        $data['sidebar'] = $this->role_module_m->side_bar(128);
        $data['news'] = $this->news_m->get_news();
        $data['data_scan_out'] = $this->good_movement_m->get_data_summary_scan_out($start_date, $finish_date);
