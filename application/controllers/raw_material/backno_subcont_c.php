...
class backno_subcont_c extends CI_Controller {

    private $layout = '/template/head';
    private $back_to_manage = 'raw_material/backno_subcont_c/index/';
...
//        if ($session['ROLE'] == '1' || $session['ROLE'] == '8' || $session['ROLE'] == '6') {
...
//        }
        ...
        $data['msg'] = $msg;
        $data['data'] = $this->raw_material_m->get_data_backno_subcont_rm();
        $data['content'] = 'raw_material/manage_backno_subcont_v';
        $data['title'] = 'Manage Back No Subcont';
