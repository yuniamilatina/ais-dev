...
class spare_parts_rack_c extends CI_Controller {
    
    private $layout = '/template/head';
    private $back_to_manage = 'samanta/spare_parts_rack_c/index/';
    private $back_to_create_view = 'samanta/spare_parts_rack_c/create_rack/';
