<script type="text/javascript">
    function refreshTable() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/raw_material/raw_material_c/refresh_table",
            type: "POST",
            dataType: 'json',
            data: {
                CHR_VERSION: e1,
                            ...
                            <table width="70%">
                                ...
                                <td>
                                    <select id="e2" name="CHR_MONTH" class="form-control" style="width:200px;">
                                        <?php for ($x = -2; $x <= 0; $x++) {
                                            $y = $x * 28 ?>
                                            <option value="<?php echo date("mY", strtotime("+$y day")); ?>"><?php echo date("M Y", strtotime("+$y day")); ?></option>
                                        <?php } ?>
                                    </select>
                                </td>
                                <td>Version</td>
                                <td>
                                    <select id="e1" name="CHR_VERSION" class="form-control" style="width:100px;">
                                        <?php for ($x = 0; $x <= 5; $x++) { ?>
            ...
            <div class="modal-wrapper">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form class="form-horizontal" method="post" role="form" action="<?php echo base_url('index.php/raw_material/raw_material_c/upload_template_data_wo'); ?>" enctype="multipart/form-data" role="form">
                            ...
                            <div class="modal-body">
                                <div class="form-group" style="text-align:center;">
                                    <span style="text-align:center;"><a href="<?php echo base_url('index.php/raw_material/raw_material_c/generate_temp_wo'); ?>">Download Template Master WO</a></span>
                                </div>
