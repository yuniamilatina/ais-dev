                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    if ($isi->CHR_DATE_START == 0) {
                                        ?>
                                        <a href="<?php echo base_url('index.php/eci/schedule_c/start_activity') . "/" . $isi->CHR_ID_ECI . "/" . $isi->INT_ID_ECI_LINE; ?>" class="label label-success" data-placement="left" data-toggle="tooltip" title="Start Activity"><span class="fa fa-play"></span></a>
                                        <!--<a class="label label-red" data-placement="left" data-toggle="tooltip" title="Start activity to give feedback"><span class="fa fa-eye"></span></a>-->
