...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <!--<a href="<?php echo base_url('index.php/eci/schedule_c/print_eci') . "/" . $isi->CHR_ID_ECI; ?>" class="label label-info" data-placement="left" data-toggle="tooltip" title="Print via Excel"><span class="fa fa-print"></span></a>-->
                                    ...
                                    <a href="<?php echo base_url('index.php/eci/schedule_c/delete_eci') . "/" . $isi->CHR_ID_ECI . "/" . $isi->INT_REV; ?>" class="label label-danger" data-placement="right" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure want to delete this data?');"><span class="fa fa-times"></span></a>
