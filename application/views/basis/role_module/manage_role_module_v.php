            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>ROLE</strong> TABLE</span>
                        <div class="pull-right">
                            <a href="<?php echo base_url('index.php/role_module_c/create_role') ?>"  class="btn btn-default" data-placement="left" data-toggle="tooltip" title="Create Role" style="height:30px;font-size:13px;width:100px;">Create</a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <table id="dataTables1" class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    ?>
                                <td>
                                    <a href="<?php echo base_url('index.php/role_module_c/view_role') . "/" . $isi->INT_ID_ROLE . "/" . NULL; ?>" class="label label-success" data-placement="left" data-toggle="tooltip" title="View"><span class="fa fa-check"></span></a>
