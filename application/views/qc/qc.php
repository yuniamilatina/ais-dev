...
<script>
	function checkVal(x) {
        ...
        var gvalue = document.getElementById(goods).value;
        var rvalue = document.getElementById(repair).value;
        var cvalue = document.getElementById(claim).value;
        var svalue = document.getElementById(scrap).value;

        if(gvalue == ""){
            gvalue = "0";
            document.getElementById(goods).value = '0';
        }
        if(rvalue == ""){
            rvalue = "0";
        ...
        if(cvalue == ""){
            document.getElementById(claim).value = '0';
        }
        if(svalue == ""){
        ...
        var good_value = parseInt(gvalue);
        var repair_value = parseInt(rvalue);
        var claim_value = parseInt(cvalue);
        var scrap_value = parseInt(svalue);
