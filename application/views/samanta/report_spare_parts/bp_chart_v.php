...
window.onload = function() {
    ...
    //report Summary CC
    var chart_summary_bp = new CanvasJS.Chart("chart_summary_bp", {
        ...
        chart_summary_bp.render();
}
</script>

<?php if ($summary_bp == false) { ?>
    <table width=100% id='filterdiagram' ><td> No data available in diagram</td></table>
<?php } else { ?>
    <div id="chart_summary_bp" style="height: 300px; width: 100%; margin-top:-100px;"></div> 
<?php } ?>