            ...
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <?php   
                        ...
                        echo form_open('samanta/spare_parts_rack_c_2/generate_lable_part_special', $attributes); 
                    ?>
                    <div class="grid-body">
                        <div>
                            <table width="60%">
                            <td><button type="submit" name="generate" class="btn btn-default tip-right" title="Print"/><i class="fa fa-print"></i>&nbsp;Special</button></td>
                            <td><button type="submit" name="save" onclick="migrasi()" class="btn btn-warning tip-right" title="Print"/><i class="fa fa-print"></i>&nbsp;Print Label</button></td>
                            <!-- <td><a href="<?php echo base_url('index.php/samanta/spare_parts_rack_c_2/generate_label_special_parts/') ?>" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Create Rack No" style="height:30px;font-size:13px;width:100px;"><i class="fa fa-print"></i>&nbsp;Label Special Part</a></td> -->
                            <td witdh = "10%"></td>
