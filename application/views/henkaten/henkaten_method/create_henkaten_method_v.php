...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/henkaten/henkaten_method_c/') ?>">Manage Henkaten Method</a></li>
            <li><a href="#"><strong>Create Henkaten Method</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE HENKATEN METHOD</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <form method="post" action="<?php echo site_url("henkaten/henkaten_method_c/save_henkaten_method") ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">NG/OK (by qty)</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <div class="btn-group">
                                        ...
                                        <?php
                                        echo anchor('henkaten/henkaten_method_c', 'Cancel', 'class="btn btn-default" data-placement="right" data-toggle="tooltip" title="Back to manage"');
                                        ?>
                                    </div>
                                </div>
                            </div>
...
<script>
    function getPartName(value) {
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('henkaten/henkaten_method_c/get_part_name'); ?>",
            data: "back_no=" + value,
