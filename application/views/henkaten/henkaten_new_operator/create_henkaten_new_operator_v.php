...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/henkaten/henkaten_new_operator_c/') ?>">Manage Henkaten MP</a></li>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE HENKATEN MP</strong> ( New Operator )</span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
                    <div class="grid-body">
                       <?php echo form_open('henkaten/henkaten_new_operator_c/save_henkaten_new_operator', 'class="form-horizontal"'); ?>
                             
                            <div class="form-group">
                                <label class="col-sm-3 control-label">NPK</label>
                                <div class="col-sm-4">
                                    <select name="CHR_NPK" id="e2" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <label><input type="radio" name="INT_STATUS_ABSEN" class="icheck" value="2"> KELUAR</label>
                                </div>
                            </div>
...
<!--                                    <div class="col-sm-2">
                                ...
                                <div  class="form-group" >
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group" >
                                            <input type="text" class="form-control date start" autocomplete="off" name="CHR_FINISH_DATE" value='<?php echo date('d-m-Y'); ?>'>
                                            <span class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
                                        </div>
                                    </div>
<!--                                    <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <div class="btn-group">
                                        ...
                                        <?php
                                        echo anchor('henkaten/henkaten_new_operator_c', 'Cancel', 'class="btn btn-default" data-placement="right" data-toggle="tooltip" title="Back to manage"');
                                        echo form_close();
                                        ?>
                                    </div>
                                </div>
...
<script>
    function getPartName(value) {
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('henkaten/henkaten_new_operator_c/get_part_name'); ?>",
            data: "back_no=" + value,
