...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/henkaten/henkaten_machine_c/') ?>">Manage Henkaten Machine</a></li>
            <li><a href="#"><strong>Create Henkaten Machine</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE HENKATEN MACHINE</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <form method="post" action="<?php echo site_url("henkaten/henkaten_machine_c/save_henkaten_machine") ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Type Henkaten Machine</label>
                                <div class="col-sm-5">
                                    <label><input type="radio" name="INT_TYPE" class="icheck" checked value="0"> PLAN</label> &nbsp;&nbsp;&nbsp;
                                    <label><input type="radio" name="INT_TYPE" class="icheck" value="1"> BREAKDOWN</label>
                                </div>
                            </div>
                            ...
                            <div id="datepairExample">
                                <div  class="form-group">
                                    ...
                                    <input type="hidden" class="form-control date start" autocomplete="off" name="CHR_SCHEDULE_DATE" value='<?php echo date('d-m-Y'); ?>'>
                                ...
                                <div  class="form-group" >
                                    ...
                                    <input type="hidden" class="form-control date start" autocomplete="off" name="CHR_ACT_DATE" value='<?php echo date('d-m-Y'); ?>'>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Status by Prd</label>
                                <div class="col-sm-5">
                                    <label><input type="radio" name="INT_FLG_NG" class="icheck" checked value="0"> NG</label> &nbsp;&nbsp;&nbsp;
                                    <label><input type="radio" name="INT_FLG_NG" class="icheck" value="1"> OK</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input name="CHR_PIC" class="form-control" required type="text" style="width: 300px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Status by Quality`</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-5">
                                    <div class="btn-group">
                                        ...
                                        <?php
                                        echo anchor('henkaten/henkaten_machine_c', 'Cancel', 'class="btn btn-default" data-placement="right" data-toggle="tooltip" title="Back to manage"');
                                        ?>
                                    </div>
                                </div>
                            </div>
...
<script>
    function getPartName(value) {
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('henkaten/henkaten_machine_c/get_part_name'); ?>",
            data: "back_no=" + value,
