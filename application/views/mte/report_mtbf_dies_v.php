...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>REPORT MTBF DIES</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>REPORT MTBF DIES </strong></span>
                    ...
                    <div class="grid-body">
                            ...
                            <table width="100%" id='filter' style="margin-bottom:-20px;">
                                <tr>
                                    <td style="vertical-align:top" width="10%">
                                        <select class="ddl2" id="tanggal" onChange="document.location.href = this.options[this.selectedIndex].value;">
                                            <?php for ($x = -3; $x <= 0; $x++) { $y = $x * 28 ?>
                                                <option value="<?php echo site_url('mte/report_line_stop_c/report_mtbf_dies/' . date("Y", strtotime("+$x year")). '/'. $id_product_group); ?>" <?php
                                                if ($selected_year == date("Y", strtotime("+$x year"))) {
                                                    echo 'SELECTED';
                                                }
                                    ...
                                    <td style="vertical-align:top" width="10%">
                                            <select onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl2">
                                                <?php foreach ($all_product_group as $row) { ?>
                                                    <option value="<?php echo site_url('mte/report_line_stop_c/report_mtbf_dies/' . $selected_year . '/' . $row->INT_ID); ?>" <?php
                                    ...
                                    <td width="75%" style="text-align:right;">
                                        <input type="button" class="btn btn-primary" onclick="tableToExcel('exportToExcel', 'Report MTBF DIES')" value="Export to Excel" style="margin-bottom: 20px;">
                                    </td>
                               </tr>
                            </table>
                        </div>
                            ...
                            <table id="example" class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                                <thead>
                                    <tr class='gradeX'>
                                        ...
                                        <th colspan='36' style="text-align:center;">MTBF DIES (H)</th>
                                    </tr>
                                    <tr class='gradeX'>
                                    ...
                                    <?php for($x = 1; $x <= 12; $x++) { ?>
                                        <th colspan="1" style="text-align: center;">OT</th>
                                        <th colspan="1" style="text-align: center;">&Sigma; LS</th>
                                        <th colspan="1" style="text-align: center;border-right: 1px solid #cdd0d4;">MTBF DIES</th>
                                    <?php } ?>
                                    </tr>
                        ...
                        <div class='pull'>
                            <div class = 'legend legend-info'>
                                <strong>Formula : </strong> <strong>MTBF DIES</strong>= Operating Time (OT)(Hour) /  &Sigma; LS Mesin (&Sigma; LS) 
                                <br>
                                <span style='font-style:italic;'>NB : Data menggunakan perhitungan akumulatif</span>
                            </div >
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>MTBF DIES SUB LINE CHART</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                    ...
                    <div class="grid-body">
                        <iframe src="<?php echo site_url('mte/report_line_stop_c/chart_mtbf_dies_by_line/' . $selected_year. '/' . $id_product_group ); ?>" height="300px" width="100%" style="border:none;"></iframe>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-header">
                        <i class="fa fa-bar-chart-o"></i>
                        <span class="grid-title"><strong>MTBF DIES GROUP PRODUCT CHART</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                            <a data-widget="remove" title="Remove"><i class="fa fa-times"></i></a>
                        </div>
                    ...
                    <div class="grid-body">
                        <iframe src="<?php echo site_url('mte/report_line_stop_c/chart_mtbf_dies_by_groupline/' . $selected_year ); ?>" height="300px" width="100%" style="border:none;"></iframe>
                    </div>
                </div>
            </div>
        </div>
