            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>POS <?php echo $data_number_pos;?> DOCUMENT</strong> LIST</span>
                        <div class="pull-right">
                            <a href="<?php echo base_url('index.php/efiling/pos_c/index/NULL' . "/" . $data_id_subsection) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Back To Pos" style="height:35px;font-size:14px;width:100px;"><i class="fa fa-arrow-left"></i> <b>Back</b></a>
							<a href="<?php echo base_url('index.php/efiling/doc_c/create_doc/NULL') . "/" . $data_id_pos ?>" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="Upload New Doc" style="height:35px;font-size:14px;width:100px;"><i class="fa fa-upload"></i> <b>Upload</b></a>
						</div>
                    </div>
                    <div class="grid-body">
                        <div class="row">
								...
								?>
									<div class="col-md-3">
										<a href="#" class="btn btn-primary btn-xl" role="button" data-toggle="modal" data-target="<?php echo'.'.$i?>" data-backdrop="static" data-keyboard="false">
											...
											<span><?php echo "<i>Latest Update </i>" . DateTime::createFromFormat('Ymd', $isi->CHR_UPLOAD_DATE)->format('d/M/Y ') . DateTime::createFromFormat('His', $isi->CHR_UPLOAD_TIME)->format('H:i:s') . " WIB"?></span>
										</a>
										<div class="btn-group">
											<a href="<?php echo base_url('index.php/efiling/doc_c/history') . "/" . $isi->INT_ID_POS . "/" . $isi->INT_ID_DOC ?>" class="btn btn-warning btn-sl" role="button"><strong>History</strong></a>
										</div>
									</div>
