<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open('efiling/pos_c/save_pos' . "/" . $data_id_subsection, 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php
                                    echo anchor('efiling/pos_c/index/NULL' . "/" . $data_id_subsection, 'Cancel', 'class="btn btn-default"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
