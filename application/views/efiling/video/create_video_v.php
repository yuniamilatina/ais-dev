        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <form method="POST" action="<?php echo site_url("efiling/video_c/save_video") ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									<div class="btn-group">
										...
										<?php
										echo anchor('efiling/video_c/index/NULL', 'Cancel', 'class="btn btn-default"');
										echo form_close();
										?>
									</div>
								</div>
