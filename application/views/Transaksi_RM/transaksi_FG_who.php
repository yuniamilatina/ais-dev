			...
			<div class="container-fluid">
				<form class="form" action="" method="post">
					<div style="text-align: center;">
						<input autocomplete="off" type="text" name="barcode" id="PP01" placeholder="PP01/PP02/PP03" style="width:200px;text-align:center;" autofocus><br>
...
if (isset($_POST['submit'])) {
	...
	elseif ($barcode == "PP01" || "PP02" || "PP03"){
				$_SESSION['barcode'] = $_POST['barcode'];
				header ("location:transaksi_FG1_who.php");
			}
