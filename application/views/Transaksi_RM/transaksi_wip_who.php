...
<nav class="navbar navbar navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<div class="navbar-brand ex">Transaksi Pengembalian Barang dari WIP (WP01)ke Warehouse (WH00)</div>	
		</div>
...
?>		
					...
					<div class="col-sm-6 ">
						<form class="form" action="" method="post">
							<div style="text-align: center;">
								<input autocomplete="off" id='qty' type="text" name="qtybox" id="qtybox" placeholder="Quantity Box" style="width:200px;text-align:center;"><br>
								<button class="btn btn-primary" id="btn-submit" name="btn_submit" value="1" style="opacity: 0.0"><i class="icon-ok icon-white"></i> Save</button>
							</div>
						</form>
					</div>	
				</div>
			...
			<div class="table-responsive bgrow"> 
				<table class="table">
					...
					<tbody>
						...
						<td><INPUT type="text" name="std" disabled></td>
						</tr>
					</tbody>
				</table>
			</div>
