...
<!--                                        <select class="ddl" id="tanggal" onChange="document.location.href = this.options[this.selectedIndex].value;">
                                    ...
                                    <td width="10%">
                                        <?php echo form_open('pes_new/report_prod_part_ng_ok_c/print_report_prod_entry', 'class="form-horizontal"'); ?>
                                        ...
                                        <?php if ($role == 17 || $role == 16 || $role == 6 || $role == 5 || $role == 32 ) { ?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php foreach ($all_dept_prod as $row) { ?>
                                                    <option value="<? echo site_url('pes_new/report_prod_part_ng_ok_c/search_prod_part/' . $selected_date . '/' . $row->INT_ID_DEPT . '/' . $work_center); ?>" <?php
                                    ...
                                    <td width="60%"> 
                                        <select id="e1" onChange="document.location.href = this.options[this.selectedIndex].value;" >
                                            <?php foreach ($all_work_centers as $row) { ?>
                                                <option value="<? echo site_url('pes_new/report_prod_part_ng_ok_c/search_prod_part/' . $selected_date . '/' . $id_prod . '/' . trim($row->CHR_WORK_CENTER)); ?>" <?php
