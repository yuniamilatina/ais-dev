<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/pes/prodentry_c/'); ?>">Production Result Entry</a></li>
            <li><a href=""><strong>Production Result Entry</strong></a></li>
        </ol>
    </section>
								...
								<td  width="5%" height="30" >Work Center</td><td>:</td><td>
									<select id="opt_wcenter" onChange="document.location.href=this.options[this.selectedIndex].value;">
									  <?php foreach($wcenters as $wcenter):?>
										  <option value="<? echo site_url('pes/prodentry_c/form_app/'.$date_l.'/'.$shift.'/'.($wcenter->CHR_WCENTER_MN).'/'.$set); ?>" <?php if($wcenter_l == $wcenter->CHR_WCENTER_MN){echo 'SELECTED';} ?> ><? echo $wcenter->CHR_WCENTER_MN; ?></option>
									  <?php endforeach;?>
