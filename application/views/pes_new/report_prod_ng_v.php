            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>PRODUCTION NG CHART</strong></span>                        
                        <div class="pull-right grid-tools">                            
                            <a href="<?php echo base_url('index.php/pes_new/report_prod_ng_c/update_data_ng"') ?>" class="btn btn-primary"  style="color:white;"><i class="fa fa-refresh"></i>&nbsp; Update Data</a>
...
<!--                        <script type='text/javascript' src='http://db-id02:8000/javascripts/api/viz_v1.js'></script>
                        <div class='tableauPlaceholder' style='width: 100%; height: 991px;'>
                            <object class='tableauViz' width='100%' height='991' style='display:none;'>
                                <param name='host_url' value='http%3A%2F%2Fdb-id02%3A8000%2F' /> 
                                <param name='embed_code_version' value='3' /> 
                                <param name='site_root' value='' />
                                <param name='name' value='RejectInLine&#47;RejectInLine' />
                        ...
                        <div class='tableauPlaceholder' style='width: 100%; height: 991px;'>
                            <object class='tableauViz' width='100%' height='991' style='display:none;'>
                                ...
                                <param name='embed_code_version' value='3' /> 
                                <param name='site_root' value='' />
                                <param name='name' value='RejectInLine_0&#47;RejectInLine' />
                                <param name='tabs' value='no' />
                                <param name='toolbar' value='yes' />
                                <param name='showAppBanner' value='false' />
                            </object>
