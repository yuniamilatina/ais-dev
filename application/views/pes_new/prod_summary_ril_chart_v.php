...
window.onload = function() {
    ...
    var chart_summary_ratio_ril = new CanvasJS.Chart("chartSummaryRatioRIL", {
    ...
    <?php
    foreach ($summary_ratio_ril as $isi) {
            ?>
    ...
    chart_summary_ratio_ril.render();
...
<?php } else { ?>
    <div id="chartSummaryRatioRIL" style="height: 300px; width: 100%; margin-top:-100px;"></div> 
<?php } ?>