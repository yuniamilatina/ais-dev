                ...
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <div class="pull-right grid-tools">
                            <a href="<?php echo base_url('index.php/patricia/master_spec_part_c/create_capacity/') ?>" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Create Capacity" style="height:30px;font-size:13px;width:100px;color:#000000;">Create</a>
                        </div>
                    </div>
                                ...
                                if ($data != NULL) {
                                    ...
                                    foreach ($data as $row) {
                                        ...
                                        <td style='text-align:center;'>
                                            <a href="<?php echo base_url('index.php/patricia/master_spec_part_c/edit_capacity') . '/' . trim($row->INT_ID); ?>" class="label label-warning" data-placement="top" data-toggle="tooltip" title="Edit"><span class="fa fa-pencil"></span></a>
