			...
			<div class="inner">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<span class="detail">The page you're looking for could not be found. <a href="<?php echo base_url('index.php/basis/home_c'); ?>">Go home instead?</a>  or <a href='javascript:history.back(1);'>Back to previous page.</a></span>
