...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/company_profile/product_c/') ?>">Create product</a></li>
            <li><a href="#"><strong>Create Product</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open_multipart('company_profile/product_c/save_product', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE</strong> PRODUCT</span>
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="CHR_PRODUCT_NAME" class="form-control" required type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="INT_ID_CATEGORY" class="form-control" required>
                                    <?php
                                        foreach ($ddl as $isi) {
                                    ?>
                                            <option value="<?php echo $isi->INT_ID_CATEGORY ?>"><?php echo $isi->CHR_CATEGORY_NAME; ?></option>        
                                    <?php
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea name="CHR_PRODUCT_DESC" class="form-control" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
