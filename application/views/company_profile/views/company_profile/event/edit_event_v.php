                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <img id="uploadPreview1" src="<?php echo base_url()."assets/img/events/".$data->CHR_EVENT_PHOTO; ?>" class="form-control" style="width: 150px; height: 150px; border: 5px solid #a1a1a1;">
                            </div>
                        </div>
                        <div class="form-group">
