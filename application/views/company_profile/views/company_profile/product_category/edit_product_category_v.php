                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <img id="uploadPreview1" src="<?php echo base_url()."assets/img/category/".$data->CHR_CATEGORY_PHOTO; ?>" class="form-control" style="width: 150px; height: 150px; border: 5px solid #a1a1a1;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"></label>
                            <div class="col-sm-5">
                                <input name="uploadFoto" id="uploadImage1" onchange="PreviewImage(1);" class="form_input" type="file">
                            </div>
                        </div>
