...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"><strong>Create Award</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open_multipart('company_profile/award_c/save_award', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE</strong> AWARD</span>
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="CHR_AWARD_NAME" class="form-control" required type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Award Date</label>
                            <div class="col-sm-5">
                                <input name="CHR_AWARD_DATE" class="form-control" required type="date">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Award Description</label>
                            <div class="col-sm-5">
                                <textarea name="CHR_AWARD_DESC" class="form-control" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Award Category</label>
                            <div class="col-sm-5">
                                <select name="CHR_AWARD_CATEGORY" class="form-control" required>
                                    <option disabled selected>-- Select Award Category --</option>
