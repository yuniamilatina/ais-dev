                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                            ...
                            <div class="col-sm-5">
                                <select name="CHR_AWARD_CATEGORY" class="form-control" required>
                                   ...
                                   <?php
                                        foreach ($ddl as $isi) {
                                    ?>
                                            <option value="<?php echo $isi->CHR_AWARD_CATEGORY ?>" <?php if($isi->CHR_AWARD_CATEGORY == $data->CHR_AWARD_CATEGORY){ echo "selected";} ?>><?php echo $isi->CHR_AWARD_CATEGORY; ?></option>        
                                    <?php
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <img id="uploadPreview1" src="<?php echo DOCIMG."/image/awards/".$data->CHR_AWARD_PHOTO; ?>" class="form-control" style="width: 150px; height: 150px; border: 5px solid #a1a1a1;">
                            </div>
                        </div>
                        <div class="form-group">
