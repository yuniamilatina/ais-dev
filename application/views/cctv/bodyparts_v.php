            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#"><i class="icon-th icon-white"></i> Body Parts</a></li>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCA02' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        <dtitle>
                            ASRH01 - ASDH01 - ASDH02
                        </dtitle>
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASRH01'. $format ?>" >
                        </div>
                    </div>
                </div>
            </div>
