            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="unitparts"><i class="icon-th icon-white"></i> Hybrid</a></li>
                        <li class="active"><a href="#"><i class="icon-th icon-white"></i> Imani & CHC</a></li>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASIM01' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASIM04' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
