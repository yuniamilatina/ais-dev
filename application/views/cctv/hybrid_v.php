            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#"><i class="icon-th icon-white"></i> Hybrid</a></li>
                        <li><a href="imani"><i class="icon-th icon-white"></i> Intake Manifold</a></li>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASHV01' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'WASH01' . $format ?>" >
                        </div>
                    </div>
                </div>
            </div>
