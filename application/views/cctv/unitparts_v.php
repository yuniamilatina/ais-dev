            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#"><i class="icon-th icon-white"></i> Unit Parts</a></li>
                        ...
                        <li><a href="stamping"><i class="icon-th icon-white"></i> Stamping</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        <dtitle>
                            ASCC01 - ASCC02 - ASCC03
                        </dtitle>
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCC01' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        <dtitle>
                            ASCD01 - ASCD02 - ASCD03
                        </dtitle>
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCD01'. $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div  class="half-unit">
                        <dtitle>ASCC03 - ASCC04</dtitle>
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCC03' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div  class="half-unit">
                        <dtitle>ASCC05</dtitle>
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCC05' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCD02' . $format ?>" >
                        </div>
                    </div>
                </div>
                <!-- <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'ASCH01' . $format ?>" >
                        </div>
                    </div>
                </div> -->
            </div>
