            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a href="#"><i class="icon-th icon-white"></i> Injection</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'PC003I' . $format ?>" >
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'PC001A'. $format ?>" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    <div class="half-unit">
                        ...
                        <hr>
                        <div class="cont">
                            <img class="imgcctv" src="<?php echo $path . 'PC003F' . $format ?>" >
                        </div>
                    </div>
                </div>
