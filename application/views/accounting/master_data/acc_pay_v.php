            ...
            <div class="col-md-4">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong id='sub-title'>Manage Account Payable</strong></span>
                    ...
                    <div>
                        <div class="grid-body" id="update_content">
                            <?php echo form_open('accounting/master_data_c/account_payable', 'class="form-horizontal"', 'action="post   "'); ?>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Id Acc Payable *</label>
                                <div class="col-sm-8">
                                    <input name="id_ap" id="id_ap" autofocus class="form-control" maxlength="4" required type="text" style="width: 100px;text-transform: uppercase;float:left;">
                                </div>

                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Acc Payable Name *</label>
                                <div class="col-sm-8">
                                    <input name="ap_name" id="ap_name" autofocus class="form-control" maxlength="50" required type="text" style="width: 95%;text-transform: uppercase;float:left;">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-8">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>ACCOUNT PAYABLE  TABLE</strong></span>
                    </div>
                    <div class="grid-body">
                        <table id="dataTables1" class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td style="text-align:center;">
                                    <a class="label label-warning" data-placement="right" data-toggle="tooltip" title="Edit" onclick="updateField('<?php echo $id_ap ?>')"><span class="fa fa-edit"></span></a>
                                    <a href="<?php echo site_url("accounting/master_data_c/account_payable/$id_ap") ?>" class="label label-danger" data-placement="right" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure want to delete this?');"><span class="fa fa-times"></span></a>
                                </td>
