                ...
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <div class="pull-right grid-tools">
                            <!-- Button untuk OPEN/LOCK Delete -->
                            <?php if($stat_del == '1'){ ?>
                            <a href="<?php echo base_url('index.php/accounting/report_aiia_c/update_function_delete/0/' . trim($start_date) . '/' . trim($end_date)) ?>" class="btn btn-danger" data-placement="left" data-toggle="tooltip" title="Enable Delete" style="height:30px;font-size:13px;width:130px;color:white;margin-top:-5px;margin-bottom:-5px;"><span class='fa fa-unlock'></span>Open Delete</a>
                            <?php } else { ?>
                            <a href="<?php echo base_url('index.php/accounting/report_aiia_c/update_function_delete/1/' . trim($start_date) . '/' . trim($end_date)) ?>" class="btn btn-success" data-placement="left" data-toggle="tooltip" title="Disable Delete" style="height:30px;font-size:13px;width:130px;color:white;margin-top:-5px;margin-bottom:-5px;"><span class='fa fa-lock'></span>Lock Delete</a>
                            <?php } ?>
                            
                            <!-- Button untuk OPEN/LOCK Backdate -->
                            <?php if($stat_backdate == '1'){ ?>
                            <a href="<?php echo base_url('index.php/accounting/report_aiia_c/update_function_backdate/0/' . trim($start_date) . '/' . trim($end_date)) ?>" class="btn btn-danger" data-placement="left" data-toggle="tooltip" title="Enable Backdate" style="height:30px;font-size:13px;width:140px;color:white;margin-top:-5px;margin-bottom:-5px;"><span class='fa fa-unlock'></span>Open Backdate</a>
                            <?php } else { ?>
                            <a href="<?php echo base_url('index.php/accounting/report_aiia_c/update_function_backdate/1/' . trim($start_date) . '/' . trim($end_date)) ?>" class="btn btn-success" data-placement="left" data-toggle="tooltip" title="Disable Backdate" style="height:30px;font-size:13px;width:140px;color:white;margin-top:-5px;margin-bottom:-5px;"><span class='fa fa-lock'></span>Lock Backdate</a>
                            <?php } ?>
                            ...
                            <a href="<?php echo base_url('index.php/accounting/report_aiia_c/export_rekap_delivery_aiia_new/' . trim($start_date) . '/' . trim($end_date)) ?>"  class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Print Report" style="height:30px;font-size:13px;width:120px;color:white;margin-top:-5px;margin-bottom:-5px;"><span class='fa fa-print'></span>Rekap AIIA</a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('accounting/report_aiia_c/search_report_by_date', 'class="form-horizontal"'); ?>
                            <table width="100%" id='filter' border=0px>                                
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <input name="START_DATE" id="datepicker1" class="form-control" autocomplete="off" required type="text" style="width:180px;" value="<?php echo date("d-m-Y", strtotime($start_date)); ?>">
                                    </td>
                                    <td width="2%">to</td>
                                    <td width="10%" style="text-align:right;">
                                        <input name="END_DATE" id="datepicker" class="form-control" autocomplete="off" required type="text" style="width:180px;" value="<?php echo date("d-m-Y", strtotime($end_date)); ?>">
                                    </td>
                                    <td width="5%" >
