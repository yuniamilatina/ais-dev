<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/efila/approval_revision_msu_c/"') ?>"><span>Approval Revision document</span></a></li>
            ...
            <div class="col-md-6">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <?php echo anchor('efila/approval_revision_msu_c', 'Back', 'class="btn btn-default"');
                                    ?>
                    </div>
                </div>
            </div>
