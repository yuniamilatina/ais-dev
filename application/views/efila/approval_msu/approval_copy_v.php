                        ...
                        <table id="dataTables1" class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    ?>
                                <td>
                                    <a href="<?php echo base_url('index.php/efila/approval_copy_msu_c/detail_copy') . "/" . $isi->INT_ID_COPY; ?>" data-placement="left" data-toggle="tooltip" title="Detail" class="label label-warning"><span class="fa fa-search"></span></a>
                                    <a href="<?php echo base_url('index.php/efila/approval_copy_msu_c/update_approval_msu') . "/1/" . $isi->INT_ID_COPY . "/" . $isi->INT_ID_DOCUMENT; ?>" data-placement="left" data-toggle="tooltip" title="Approve" class="label label-success" onclick="return confirm('Are you sure want to approve this document?');"><span class="fa fa-check"></span></a>
                    ...
                    <div class="modal-wrapper">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <?php echo form_open('efila/approval_copy_msu_c/update_approval_msu/0', 'class="form-horizontal"'); ?>
