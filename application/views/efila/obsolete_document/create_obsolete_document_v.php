<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/efila/obsolete_document_c/') ?>">Manage Obsolete Document</a></li>
            <li><a href="#"><strong>Obsolete Document</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open_multipart('efila/obsolete_document_c/save_obsolete_document', 'class="form-horizontal"', $attributes);
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>OBSOLETE</strong> DOCUMENT</span>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php echo anchor('efila/obsolete_document_c', 'Cancel', 'class="btn btn-default"');
                                    ?>
                                </div>
                            </div>
                        </div>
