<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/efila/obsolete_document_c/"') ?>"><span>Manage Obsolete Document</span></a></li>
                        ...
                        <table id="dataTables1" class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($doc as $isi) {
                                    ...
                                    <td><a href="<?php echo base_url('index.php/efila/obsolete_document_c/create_obsolete_document') . "/" . $isi->INT_ID_DOCUMENT; ?>" class="label label-warning" title="Obsolete Document" data-toggle="tooltip"><span class="fa fa-pencil"></span></a></td>
                                </tr>
                                <?php
                                $i++;
                            }
