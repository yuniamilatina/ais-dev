                        ...
                        <table id="dataTables1" class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    echo "<td>$date</td>";
                                    ?>
                                    <td><a target="_BLANK" href="<?php echo base_url('index.php/efila/approval_obsolete_manager_c/view_doc') . "/" . $isi->CHR_DOC; ?>"><?php echo $isi->CHR_DOC; ?></a></td>
                                <td>
                                    <a href="<?php echo base_url('index.php/efila/approval_obsolete_manager_c/detail_obsolete') . "/" . $isi->INT_ID_OBSOLETE; ?>" data-placement="left" data-toggle="tooltip" title="Detail" class="label label-warning"><span class="fa fa-search"></span></a>
                                    <a href="<?php echo base_url('index.php/efila/approval_obsolete_manager_c/update_approval_manager') . "/1/" . $isi->INT_ID_OBSOLETE . "/" . $isi->INT_ID_DOCUMENT; ?>" data-placement="left" data-toggle="tooltip" title="Approve" class="label label-success" onclick="return confirm('Are you sure want to approve this document?');"><span class="fa fa-check"></span></a>
                    ...
                    <div class="modal-wrapper">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <?php echo form_open('efila/approval_obsolete_manager_c/update_approval_manager/0', 'class="form-horizontal"'); ?>
