<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/efila/approval_register_manager_c/"') ?>"><span>Approval Register</span></a></li>
            ...
            <div class="col-md-4">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <?php echo anchor('efila/approval_register_manager_c', 'Back', 'class="btn btn-default"');
                                    ?>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid-body">
                        <table class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                <td><a target="_blank" href="<?php echo base_url('index.php/efila/approval_register_manager_c/view_doc') . "/" . $isi->CHR_DOC; ?>"><?php echo $isi->CHR_DOC; ?></a></td>
                                </tr>
                                <?php
                                $i++;
                            }
