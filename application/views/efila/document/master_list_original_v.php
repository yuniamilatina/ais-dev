        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('efila/master_list_original_c/filter_category', 'class="form-inline"'); ?>
                            <table width="100%">
                                <tr>
                                    <td>Category</td>
                                    <td>
                                    ...
                                    <td><button type="submit" class="btn btn-primary" name="set"><i class="fa fa-check"></i> Set</button>
                                        <a href="<?php echo base_url('index.php/efila/master_list_original_c') ?>" class="btn btn-default">Clear</a>
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) { 
                                    ...
                                    <tr class='gradeX'>
                                        ...
                                        <td><?php echo $date; ?></td>
                                        <?php $doc = $isi['CHR_DOC']; ?>
                                        <td><a target="_blank" href="<?php echo base_url('index.php/efila/master_list_original_c/view_doc_original') . "/" . $doc; ?>"><i class="fa fa-download"></i></a></td>
                                    <?php 
