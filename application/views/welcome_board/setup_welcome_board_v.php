...
<html>
    ...
    <body style='background: #0A64E0;'>
        <div class="container">
            <center><div class="toggleMenu">WELCOME TO AISIN INDONESIA (AII)</div></center>
            <ul class="nav">
                <li  class="test">
                    <a href="#">HOME</a>
                    <ul class='ul-maps'>
                ...
                <li>
                    ...
                    <ul class='ul-maps'>
                        ...
                        <li class='li-maps'><input type="checkbox" <?php echo $checkbox7; ?> onclick='window.location.assign("<?php echo base_url('index.php/welcome_board/welcome_board_setup_c/index/7') ?>")'  id="test5" /><label for="test5"><span class="ui"></span>Sport Arena</label></li>
                        <li class='li-maps'><input type="checkbox" <?php echo $checkbox11; ?> onclick='window.location.assign("<?php echo base_url('index.php/welcome_board/welcome_board_setup_c/index/11') ?>")'  id="test11" /><label for="test11"><span class="ui"></span>Mini Mart</label></li>
                    </ul>
                </li>
                <li>
                    <a href="#">VIDEO</a>
                ...
                <li  class="test">
                    <a href="#">PLANT TOUR</a>
                    <ul class='ul-maps'>
                        <li class='li-maps'><input type="checkbox" <?php echo $checkbox12; ?> onclick='window.location.assign("<?php echo base_url('index.php/welcome_board/welcome_board_setup_c/index/12') ?>")' id="test12" /><label for="test12"><span class="ui"></span>Documentation</label></li>
                    </ul>
                </li>
            </ul>
        </div>
