...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/prd/change_status_elina_c/'); ?>"><span>Data Order Elina Stock OK</span></a></li>
            <li><a href=""><strong>Edit Data Part Stock OK</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open('prd/change_status_elina_c/update_data_stat', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>EDIT DATA PART STOCK OK</strong></span>
                    ...
                    <div class="grid-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Stock System (PCS)</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-3">
                                <div class="btn-group">
                                    ...
                                    <?php
                                    echo anchor('prd/change_status_elina_c', 'Cancel', 'class="btn btn-default"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
