...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="#"><strong>Edit Schedule Kanban</strong></a></li>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>EDIT SCHEDULE KANBAN</strong></span>
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input name="INT_SEQUENCE" class="form-control" autocomplete="off" onkeyup="angka(this);" maxlength="50" required type="number" min="1" max="<?php echo $max_seq; ?>" value="<?php echo $data->INT_SEQUENCE; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input name="INT_QTY_PER_BOX" class="form-control" autocomplete="off" onkeyup="angka(this);" maxlength="100" type="text" value='<?php echo $data->INT_QTY_PER_BOX; ?>'>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php
                                    echo anchor('prd/schedule_kanban_c/search_schedule_kanban/' . $period . '/' . $id_dept . '/' . trim($data->CHR_WORK_CENTER) . '/' . $status, 'Cancel', 'class="btn btn-default"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
