...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li> <a href="<?php echo base_url('index.php/part/pos_material_c/manage_pos_material') ?>">MANAGE  POS MATERIAL</a></li>
            <li> <a href="#"><strong>EDIT POS MATERIAL</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title" id="stat-create2"><strong id="stat-create">EDIT POS MATERIAL</strong></span>
                    ...
                    <div class="grid-body">
                    <?php
                    echo form_open_multipart('prd/pos_material_c/reupload_pos_material', 'class="form-horizontal"');
                    ?>
                    ...
                    <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php
                                    echo anchor('prd/pos_material_c', 'Cancel', 'class="btn btn-default"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
