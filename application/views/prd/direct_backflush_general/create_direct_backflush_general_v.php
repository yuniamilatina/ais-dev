...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li> <a href="<?php echo base_url('index.php/prd/direct_backflush_general_c') ?>">MANAGE ROTATION KANBAN</a></li>
            <li> <a href="#"><strong>CREATE ROTATION KANBAN</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title" id="stat-create2"><strong id="stat-create">CREATE ROTATION KANBAN</strong></span>
                    ...
                    <div class="grid-body">
                    <?php
                    echo form_open('prd/direct_backflush_general_c/save_direct_backflush', 'class="form-horizontal"');
                    ?>
                   
                   <div class="form-group">
                            <label class="col-sm-3 control-label">Department</label>
                            <div class="col-sm-2" >
                                <input name="CHR_DEPT" autocomplete="off" class="form-control" maxlength="5" required type="text" style="text-transform: uppercase;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Work Center</label>
                            <div class="col-sm-2" >
                                <input required name="CHR_WCENTER" type="text" autocomplete="off" onkeyup="angka(this);" maxlength="50" required class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-2" >
                                <input required name="CHR_REMARK" type="text" autocomplete="off" onkeyup="angka(this);" maxlength="50" required class="form-control">
                            </div>
                    </div>
