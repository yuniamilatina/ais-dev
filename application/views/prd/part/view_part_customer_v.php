            ...
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="form-group">
                        <div id="bg-big" style="width:80%;height:600px;background-image: url('<?php echo base_url($data->CHR_IMG_FILE_NAME); ?>');background-size: 940px 600px;background-repeat: no-repeat;margin: 0px 0px 0px 0px;position:relative;" >
                            <?php
                            if (count($data_detail) > 0) {
                                foreach ($data_detail as $row) {
                                    ...
                                    $top = $row->CHR_HEIGHT;
                                    $cek_no = $row->INT_ID;
                                    echo '<img id="img-point-' . $cek_no . '" src="'.base_url('/assets/img/nunjuk.png').'" style="width:100px;height:100px;position:absolute;top: ' . $top . 'px;left:' . $left . 'px;">';
                                }
                            }
                            ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#bg-big").click(function(e) {
            ...
            $("#point_rep").remove("");
            $("#bg-big").append("<img id='point_rep' src='<?php echo base_url('/assets/img/nunjuk.png') ?>' style='width:100px;height:100px;position:absolute;top: " + intYPosition + "px;left:" + intXPosition + "px;'>");
        });
