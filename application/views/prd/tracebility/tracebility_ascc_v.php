...
<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open('prd/tracebility_c/get_tracebility_ascc', 'class="form-horizontal"');
        ?>
        <div class="pull">
            <?php
                if ($msg != NULL) {
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">PART TRACEABILITY - CLUTCH COVER (CC) PARTS</span>
                    </div>
                    <div class="grid-body">
                        <div class="pull">
                            <table width="100%" id='filter' border=0px>
                                <tr style="vertical-align: center">
                                    ...
                                    <td width="20%">
                                        <select id="work_center" name="work_center" class="ddl2" style="width:180px;">
                                            <?php
                                            foreach ($ascc_wcenters as $row) {
                            ...
                            <table width="100%" id='filter' border=0px>
                                <tr style="vertical-align: center">
                                    ...
                                    <strong>
                                        <?php echo "<a data-toggle='modal'data-target='#modal" . $qr_barcode ."' title='Trace Forward'>$qr_barcode</a>"; ?>
                                        <!-- <input type="button" class="btn btn-info" value="<?php echo $qr_barcode; ?>" onclick="get_trace_delivery(this.value)"> -->
                                    </strong>
                                    </td>
                                    <td width="5%">
                                    </td>
                        ...
                        <table  class="table display" cellspacing="0"  width="100%">
                            <thead>
                            <tr>
                                <th colspan="10" style="text-align: center">M O D E L</th>
                                <tbody>
                                <?php
                                    if (!empty($datatester)){
                                        echo "<tr class='gradeX'>";
                                        echo "<td colspan='10' style='text-align: center; color: black; font-size: 16px'><strong>$datatester->CHR_MODEL</strong></td>";
                                        echo "</tr>";
                                        }
                                        else {
                                ...
                                <tr>
                                    ...
                                    <th colspan="10" style="text-align: center">UPPER LIMIT</th>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($datatester)){
                                            ...
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_FIN_POINT,1,',','.') . "</strong></td>";
                                            echo "<td colspan='3' style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_AMN_MIG,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_AMN_TRANS/100,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_GOING_WEAR,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_GOING_SET,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_RETURN_WEAR,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_RETURN_SET,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_UPP_HYSTERIS,0,',','.') . "</strong></td>";
                                            echo "</tr>";
                                        }
                                        else { }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center"> FIN POINT</th>
                                    <th style="text-align: center"> AMN MIG 1</th>
                                    <th style="text-align: center"> AMN MIG 2</th>
                                    <th style="text-align: center"> AMN MIG 3</th>
                                    <th style="text-align: center"> AMN TRANS</th>
                                    <th style="text-align: center"> GOING WEAR</th>
                                    <th style="text-align: center"> GOING SET</th>
                                    <th style="text-align: center"> RETURN WEAR</th>
                                    <th style="text-align: center"> RETURN SET</th>
                                    <th style="text-align: center"> HYSTERIS</th>
                                </tr>
                                    <tbody>
                                        <?php
                                        if (!empty($datatester)){
                                            echo "<tr class='gradeX'>";
                                            // echo "<td rowspan='5' style='text-align: center; color: black; font-size: 18px'><strong>$datatester->CHR_MODEL</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_FIN_POINT,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_AMN_MIG_1/100,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_AMN_MIG_2/100,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_AMN_MIG_3/100,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_AMN_TRANS/100,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_GOING_WEAR,1,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_GOING_SET,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_RETURN_WEAR,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_RETURN_SET,0,',','.') . "</strong></td>";
                                            echo "<td style='text-align: center; background-color: #FFA500; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_RESULT_HYSTERIS,0,',','.') . "</strong></td>";
                                            echo "</tr>";
                                        }
                                        else { }
                                        ?>
                                ...
                                <tr>
                                    <!-- <th style="text-align: center"></th> -->
                                    <th colspan="10" style="text-align: center">LOWER LIMIT</th>
                            ...
                            <tbody>
                                ...
                                if (!empty($datatester)){
                                    echo "<tr class='gradeX'>";
                                    // echo "<td rowspan='5' style='text-align: center; color: black; font-size: 18px'><strong>$datatester->CHR_MODEL</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_FIN_POINT,1,',','.') . "</strong></td>";
                                    echo "<td colspan='3' style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_AMN_MIG/100,1,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_AMN_TRANS/100,1,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_GOING_WEAR,1,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_GOING_SET,0,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_RETURN_WEAR,0,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_RETURN_SET,0,',','.') . "</strong></td>";
                                    echo "<td style='text-align: center; background-color: #4d79ff; color: white; font-size: 18px'><strong>" . number_format($datatester->CHR_LOW_HYSTERIS,0,',','.') . "</strong></td>";
                                    echo "</tr>";
                                }
                                else { }
                                ?>
        ...
        ?>    
                    ...
                    <!-- <div class="modal" id="modalTraceForward" tabindex="-1" aria-hidden="true" style="display: none;">
...
<script>
    function get_trace_delivery(barcode){
        var wc =  '<?php echo trim($work_center) ?>';
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('prd/tracebility_c/get_trace_delivery_ascc'); ?>",
            data: "id_code=" + barcode + "&wcenter=" + wc,
            success: function (data) {
                // alert('SUCCESS');     
                $("#modalTraceForward").html(data);
            },
            error: function (data) {
                alert(data);
            }
