...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/prd/lot_kanban_c/manage_overstock_parts') ?>"><strong>Manage Overstock Parts</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>MANAGE OVERSTOCK PARTS</strong></span>
                        <div class="pull-right grid-tools">
                            <a href="<?php echo base_url('index.php/prd/lot_kanban_c/upload_overstock_parts/' . $id_dept) ?>"  class="btn btn-default" data-placement="left" data-toggle="tooltip" title="Upload Overstock Parts" style="height:30px;font-size:13px;width:100px;color:grey;margin-top:-5px;margin-bottom:-5px;">Upload</a>
                            <a data-toggle="modal" data-target="#modalAddInfo"  class="btn btn-primary" data-placement="left" title="Add Part" style="height:30px;font-size:13px;width:100px;color:white;margin-top:-5px;margin-bottom:-5px;">Add Part</a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <div class="pull">
                            <table width="100%" id='filter' border=0px>
                                ...
                                <tr> 
                                    <td width="5%">Dept</td>
                                        <td width="5%">
                                            <select name="INT_ID_DEPT" id="dept_to_work_center" onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl2" style="width:150px;">
                                                <?php
                                                foreach ($all_dept_prod as $row) {
                                                    if (trim($row->INT_ID_DEPT) == trim($id_dept)) {
                                                        ?>
                                                        <option selected value="<?php echo site_url('prd/lot_kanban_c/manage_overstock_parts/0/' . trim($row->INT_ID_DEPT)); ?>"><?php echo trim($row->CHR_DEPT); ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo site_url('prd/lot_kanban_c/manage_overstock_parts/0/' . trim($row->INT_ID_DEPT)); ?>"><?php echo trim($row->CHR_DEPT); ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    if($data->num_rows() > 0){
                                        foreach ($data->result() as $isi) {
                                            ...
                                            echo "<td style='text-align:center;'>$isi->CHR_NOTES</td>";                                        
                                            ?>
                                        <td style='text-align:center;'>
                                            ...
                                            <a href="<?php echo base_url('index.php/prd/lot_kanban_c/delete_overstock_parts') . "/" . trim($id_dept) . "/" . $isi->INT_ID ?>" class="label label-danger" onclick="return confirm('Are you sure want to delete this data?');" data-placement="top" data-toggle="tooltip" title="Delete"><span class="fa fa-times"></span></a>
                                        </td>
                                        </tr>
                                        <?php
                                        $i++;
                            ...
                            <div class="modal-wrapper">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?php echo form_open('prd/lot_kanban_c/update_overstock_parts', 'class="form-horizontal"'); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" id="add_notes" name="chr_notes" class="form-control" required value="<?php echo trim($isi->CHR_NOTES) ?>" >
                                                </div>
                                            </div>
                            ...
                            <div class="modal-wrapper">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="modalprogress"><strong>Add Overstock Parts</strong></h4>
                                        </div>
                                        
                                        <div class="modal-body">
                                        <?php echo form_open('prd/lot_kanban_c/add_overstock_part', 'class="form-horizontal"'); ?>
                                            <input name="INT_ID_DEPT" class="form-control" required type="hidden" style="width: 300px;" value="<?php echo $id_dept; ?>">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Part No</label>
                                                <div class="col-sm-5">
                                                <select id="e1" name="chr_part_no" class="form-control">
                                                    <?php
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Notes</label>
                                                <div class="col-sm-5">
                                                    <input type="text" id="chr_notes" name="chr_notes" class="form-control" value="" >
                                                </div>
                                            </div>
