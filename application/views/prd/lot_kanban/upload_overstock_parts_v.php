...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/prd/lot_kanban_c/manage_overstock_parts') ?>">Manage Overstock parts</a></li>
            <li class="active"> <a href="#"><strong>Upload Overstock Parts</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>UPLOAD OVERSTOCK PARTS</strong></span>
                        <div class="pull-right grid-tools">
                               <a  href="<?php echo base_url('index.php/prd/lot_kanban_c/download_template_overstock_parts') ?>"  name="btn-download" data-toggle="tooltip" data-placement="right" title="Download template"><i class="fa fa-download"></i>&nbsp; Download Template</a>
                        </div>
                    </div>
                    <div class="grid-body" style="padding-top: 25px;">
                    <?php echo form_open_multipart('prd/lot_kanban_c/confirm_upload_overstock_parts', 'class="form-horizontal"');?>
                            ...
                            <table width="100%" id='filter' border=0>
                                ...
                                <td width="10%" style='text-align:left;' ><strong>File (.xlsx)</strong></td>
                                    <td width="27%" style='text-align:left;' colspan="3">
                                        <input type="file" name="upload_overstock_parts" class="form-control" id="import" required> 
                                    </td>
                                    <td width="43%">
                    ...
                    <!-- 32150020150P0 -->
                    <?php echo form_close(); ?>
                    <?php echo form_open('prd/lot_kanban_c/save_overstock_parts_upload', 'class="form-horizontal"'); ?>
                    ...
                    <div class="grid-body" style="padding-top: 0px">
                                ...
                                <tbody>
                                    ...
                                    for($y = 0; $y < $increment; $y++){
                                        ...
                                        <tr class='gradeX'>
                                            ...
                                            <td >
                                                <input readonly name="tableRow[<?php echo $y; ?>][CHR_NOTES]" type='text' value="<?php echo $data[$y]['CHR_NOTES'];?>"  style='border:none;width:50px;background:transparent;'></input>
                                            </td>
                            ...
                            <br>
                                ...
                                <?php if ($data == true) { ?>
                                    ...
                                    <a href="<?php echo base_url('index.php/prd/lot_kanban_c/manage_overstock_parts/0/' . $id_dept) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Back">Back</a>
                                <?php } else { ?>
