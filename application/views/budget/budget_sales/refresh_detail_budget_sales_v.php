                            ...
                            <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>                                        
                                        ...
                                        <th rowspan="2" style="vertical-align: middle;text-align:center;">Code Product</th>
                                ...
                                <tbody>
                                    <?php          
                                        ...
                                        foreach ($sub_category as $value) {
                                            $detail_budget = $this->db->query("SELECT CHR_BUDGET_SUB_CATEGORY_DESC, CHR_PURPOSE, CHR_CODE_UNIQ_PRODUCT, CHR_FLAG_APP_DIR, CHR_FLAG_APP_GM, CHR_FLAG_APP_MAN,
                                                                    ...
                                                                    GROUP BY CHR_BUDGET_SUB_CATEGORY_DESC, CHR_PURPOSE, CHR_CODE_UNIQ_PRODUCT, CHR_FLAG_APP_DIR, CHR_FLAG_APP_GM, CHR_FLAG_APP_MAN")->result();
                                            $qty_bln04 = 0;
                                            $qty_bln05 = 0;
                                            $qty_bln06 = 0;
                                            $qty_bln07 = 0;
                                            ...
                                            foreach($detail_budget as $data){
                                                ...
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->CHR_PURPOSE . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->CHR_CODE_UNIQ_PRODUCT . '</td>';
                                                
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN04 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN04) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN05 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN05) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN06 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN06) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN07 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN07) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN08 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN08) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN09 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN09) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN10 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN10) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN11 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN11) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN12 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN12) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN01 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN01) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN02 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN02) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_BLN03 . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . number_format($data->MON_AMT_BLN03) . '</td>';
                                                echo '<td style="vertical-align: middle;text-align:center;">' . $data->INT_QTY_SUM . '</td>';
                                                ...
                                                $qty_bln04 = $qty_bln04 + $data->INT_QTY_BLN04;
                                                $qty_bln05 = $qty_bln05 + $data->INT_QTY_BLN05;
                                                $qty_bln06 = $qty_bln06 + $data->INT_QTY_BLN06;
                                                $qty_bln07 = $qty_bln07 + $data->INT_QTY_BLN07;
                                                $qty_bln08 = $qty_bln08 + $data->INT_QTY_BLN08;
                                                $qty_bln09 = $qty_bln09 + $data->INT_QTY_BLN09;
                                                $qty_bln10 = $qty_bln10 + $data->INT_QTY_BLN10;
                                                $qty_bln11 = $qty_bln11 + $data->INT_QTY_BLN11;
                                                $qty_bln12 = $qty_bln12 + $data->INT_QTY_BLN12;
                                                $qty_bln01 = $qty_bln01 + $data->INT_QTY_BLN01;
                                                $qty_bln02 = $qty_bln02 + $data->INT_QTY_BLN02;
                                                $qty_bln03 = $qty_bln03 + $data->INT_QTY_BLN03;
                                                $qty_all = $qty_all + $data->INT_QTY_SUM;
                                            ...
                                            echo '<tr>';
                                            echo '<td style="font-weight: bold;text-align: right;background-color: #dddddd; color: #dddddd;">'. $no .'</td>';
