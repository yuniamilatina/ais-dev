                                ...
                                <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" style="vertical-align: middle;text-align:center;">Item Rental</th>  
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($detail_confirm as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_ITEM_RENT; ?></td>
