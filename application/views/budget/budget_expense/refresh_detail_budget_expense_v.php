        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><strong><i>Detail Data Factory Overhead (FOH)</i></strong> <?php if($DIV != ''){ echo ' - ('.trim($DIV).')';} if($GROUP != ''){ echo ' - ('.trim($GROUP).')';} if($DEPT != ''){ echo ' - ('.trim($DEPT).')';} if($SECT != ''){ echo ' - ('.trim($SECT).')';}?></span>
                </div>
                <div class="grid">                    
            ...
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><strong><i>Detail Data Operating Expense (OPEX)</i></strong> <?php if($DIV != ''){ echo ' - ('.trim($DIV).')';} if($GROUP != ''){ echo ' - ('.trim($GROUP).')';} if($DEPT != ''){ echo ' - ('.trim($DEPT).')';} if($SECT != ''){ echo ' - ('.trim($SECT).')';}?></span>
                </div>
                <div class="grid">
                    <div class="grid-body" style="padding-top: 0px">
                        <div id="table-luar">
