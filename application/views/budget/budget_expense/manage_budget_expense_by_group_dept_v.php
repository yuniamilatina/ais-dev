...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="<?php echo base_url('index.php/budget/budget_expense_c/"') ?>"><strong>Group Department</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-6">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">EXPENSE<strong> <?php echo $org->CHR_GROUP_DEPT; ?></strong> Group Dept</span>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header bg-blue">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel9">Commit <?php echo $header->CHR_GROUP_DEPT; ?> Budget</h4>

                                            </div>
<?php echo form_open('budget/budget_expense_c/commit_expense/' . $header->INT_ID_GROUP_DEPT, 'class="form-horizontal"'); ?>
                                            <div class="modal-body">
                                                <div class="modal-body">
                                                    <p>Are you sure want to commit this Group Department's Budgets?</p>
...
<?php echo form_close(); ?>
                    ...
                    <div class="grid-body">
                        <?php if ($header != NULL) { ?>
                            <h4 class="col-sm-12">Total <strong><?php echo $header->CHR_GROUP_DEPT ?></strong>'s Budget: Rp <strong><?php echo number_format($header->DEC_TOTAL) ?> </strong></h4>
                            <?php
                        }
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    foreach ($data_status as $value) {
                                        if ($value->INT_ID_DEPT == $isi->INT_ID_DEPT) {
                                            $approve = $value->INT_APPROVE;
                                            if ($value->INT_APPROVE == 4) {
                                                $box = "<td><input class='icheck' type='checkbox' id='select' name='case[]' value='" . $isi->INT_ID_DEPT . "'></input></td>";
                                            }
                                        }
                                    }
                                    echo $box;
                                    ...
                                    ?>
                                <td>
                                    <a href="<?php echo base_url('index.php/budget/budget_expense_c/select_expense_by_dept') . "/" . $isi->INT_ID_DEPT ?>" class="label label-success"><span class="fa fa-search"></span></a>
                                    <?php if ($approve == 4) { ?>
                                        <a href="<?php echo base_url('index.php/budget/budget_expense_c/reject_expense') . "/" . $isi->INT_ID_DEPT . "/" ?>" class="label label-danger"  onclick="return confirm('Are you sure want to reject this budget expense?');"><span class="fa fa-times"></span></a>
    <?php } ?>
