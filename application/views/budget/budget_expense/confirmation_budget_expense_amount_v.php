...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="#"><strong>Confirm Budget Expense by Amount</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong style="text-transform: uppercase;">CONFIRM BUDGET EXPENSE BY AMOUNT  - <?php $CHR_DEPT_DESC . " - " . $CHR_SECTION_DESC . "  (" . $CHR_FISCAL_YEAR . ")" ?></strong></span>
                    ...
                    <div class="grid-body" style="padding-bottom: 0px;padding-top: 25px;">
                        ...
                        <div class="form-group">
                            ...
                            <a href='<?php echo site_url("budget/budget_expense_by_amount_c/save_budget/$INT_ID_FISCAL_YEAR/$INT_ID_BUDGET_SUB_GROUP/$INT_DIV/$INT_DEPT/$INT_SECT/RMB") ?>' type="submit" class="btn btn-success"  name="btn-save" value="1" style="float: right;margin-right: 15px;"><i class="fa fa-check"></i>&nbsp; Confirm</a>
                        </div>
