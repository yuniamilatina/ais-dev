                                ...
                                <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" style="vertical-align: middle;text-align:center;">Kind of Activity</th>
                                            ...
                                            <th colspan="3" style="text-align:center;">Apr</th>
                                            <th colspan="3" style="text-align:center;">May</th>
                                            <th colspan="3" style="text-align:center;">Jun</th>
                                            <th colspan="3" style="text-align:center;">Jul</th>
                                            <th colspan="3" style="text-align:center;">Aug</th>
                                            <th colspan="3" style="text-align:center;">Sept</th>
                                            <th colspan="3" style="text-align:center;">Oct</th>
                                            <th colspan="3" style="text-align:center;">Nov</th>
                                            <th colspan="3" style="text-align:center;">Dec</th>
                                            <th colspan="3" style="text-align:center;">Jan</th>
                                            <th colspan="3" style="text-align:center;">Feb</th>
                                            <th colspan="3" style="text-align:center;">Mar</th>
                                            <th colspan="3" style="text-align:center;">Total Yearly</th>
                                        </tr>
                                        <tr>
                                            <?php for ($i = 1; $i <= 13; $i++) { ?>
                                                <th>Qty</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($detail_confirm as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_KIND_OF; ?></td>
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_PERIODE; ?></td>
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_SHIFT; ?></td> 
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN04); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN05); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN06); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN07); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN08); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN09); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN10); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN11); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN12); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN01); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN02); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN03); ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_SUM); ?></td>
                                        ...
                                        <?php foreach ($detail_confirm_sum as $value) { ?>
                                            <tr>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN04); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN05); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN06); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN07); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN08); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN09); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN10); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN11); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN12); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN01); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN02); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_BLN03); ?></td>
                                                ...
                                                <td style="font-weight: bold;vertical-align: middle;text-align:center;"><?php echo number_format($value->FLT_ADD_SUM); ?></td>
