...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function refreshTable() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_expense_c/refresh_detail_table",
                type: "POST",
                dataType: 'json',
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_expense_c/refresh_summary_table",
        ...
        $("#INT_ID_DIV").change(function() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_expense_c/gen_ddl_groupdept",
            ...
            var a = '';
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_expense_c/gen_ddl_dept",
            ...
            var b = '';
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_expense_c/gen_ddl_section_app",
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/budget/budget_expense_c/"') ?>">Approval Budget Expense</a></li>
            <li class="active"> <a href="#"><strong>Approval Budget Expense</strong></a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>APPROVAL BUDGET EXPENSE</strong></span>
                    ...
                    <div class="grid-body">
                        <?php echo form_open_multipart('budget/budget_expense_c/approve_budget_expense', 'class="form-horizontal"');
                        ?>
                        ...
                        <div class=" form-group">  
                            ...
                            <div class="col-sm-3">
                                <select autofocus name="INT_ID_DIV" id="INT_ID_DIV" required class="form-control" style="width:250px">
                        ...
                        <div class=" form-group">  
                            ...
                            <div class="col-sm-3">
                                <select autofocus name="INT_ID_GROUP" id="INT_ID_GROUP" required class="form-control" style="width:250px">
                                    <option value=""> -- Select Div (GM) -- </option>
                                    <?php
            ...
            <div class="col-md-12" id="sum_table" style="display:none;">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>DETAIL EXPENSE CATEGORY BUDGET BY DEPT</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-md-12" id="sum_table2" style="display:none;">
                <div class="grid">
                    <div class="grid-header">
                        <i class="fa fa-table"></i>
                        <span class="grid-title"><strong>SUMMARY ALL EXPENSE</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
