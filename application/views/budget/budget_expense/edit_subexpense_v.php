        ...
        <div class="row">
            ...
            <div class="grid">
                <div class="grid-header">
                    ...
                    <span class="grid-title">EDIT BUDGET <strong>SUBEXPENSE</strong></span>
                    <div class="pull-right grid-tools">
                        <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                    </div>
                </div>
                <div class="grid-body">
                    <?php echo form_open('budget/budget_expense_c/update_budget_expense/s/'.$data->INT_REVISE, 'class="form-horizontal"'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">  
                            <select name="UOM" id="UOM" required class="form-control" style="width:250px">
                                <?php
                                foreach ($unit as $isi) {
                                    ?>
                        ...
                        <div class="col-sm-3">
                            <input name="PRICE_PER_UNIT" id="PRICE_PER_UNIT" class="form-control" style="width:250px" maxlength="20" value="<?php echo trim($data->DEC_MONEY_PER_UNIT) ?>" required type="number">
                        </div>
                    </div>
                    <hr>
