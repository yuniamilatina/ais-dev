                                ...
                                <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" style="vertical-align: middle;text-align:center;">Budget Type</th>
                                            <th rowspan="2" style="vertical-align: middle;text-align:center;">Name of Budget Type</th>
                                            ...
                                            <th rowspan="2" style="vertical-align: middle;text-align:center;">Category A3</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($summary_company as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_BUDGET_TYPE; ?></td>
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_BUDGET_TYPE_DESC; ?></td>
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_BUDGET_SUB_CATEGORY; ?></td>
                                                ...
                                                <td style="vertical-align: middle;text-align:center;"><?php echo $value->CHR_CODE_CATEGORY_A3; ?></td>
                                        ...
                                        ?>
                                        <?php foreach ($tot_summary_company as $value) { ?>
                                            <tr>
