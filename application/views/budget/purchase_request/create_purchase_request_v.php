        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('budget/purchase_request_c/search_budget_capex', 'class="form-horizontal"'); ?>
                            ...
                            <br> 
                            <?php if ($stat_cip == 0) { ?>
                                <label class="radio-inline"><input type="radio" name="BIT_FLG_CIP" class="icheck" value=0 checked> CIP</label>
                                <label class="radio-inline"><input type="radio" name="BIT_FLG_CIP" class="icheck" value=1> Non-CIP</label>
                            <?php } else { ?>
                                <label class="radio-inline"><input type="radio" name="BIT_FLG_CIP" class="icheck" value=0> CIP</label>
                                <label class="radio-inline"><input type="radio" name="BIT_FLG_CIP" class="icheck" value=1 checked> Non-CIP</label>
                            <?php } ?>
                        ...
                        <table id="dataTables3" class="table table-condensed table-striped table-bordered table-responsive display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    ?>
                                <td>
                                    <a href="<?php echo base_url('index.php/budget/purchase_request_c/add_pureq_detail') . "/" . $isi->INT_NO_BUDGET . "/" . "0" . "/" . $stat_cip. "/".$section . "/".$dept; ?>" class="label label-success"><span class="fa fa-plus"></span></a>
                                </td>
                                </tr>
                            ...
                            <table id="dataTables1" class="table table-condensed table-striped table-bordered display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_pr as $isi) {
                                        ...
                                        ?>
                                    <td>
                                        <a href="<?php echo base_url('index.php/budget/purchase_request_detail_c/remove_budget') . '/' . $isi->INT_NO_BUDGET . '/' . $isi->INT_NO_PUREQ_TEMP . '/' .$stat_cip . '/' .$section . '/' .$dept; ?>" class="label label-danger"><span class="fa fa-times"></span></a>
                                    </td>
                                    </tr>
                                ...
                                <div class = "pull-right">
                                    <div class = "form-group">
                                        <div class = "btn-group">
                                            ...
                                            ?>
                                            <input name="INT_ID_FISCAL_YEAR" class="form-control" type="hidden" value="<?php echo $new_fiscal; ?>">
                                            <input name="INT_ID_SECTION" class="form-control" type="hidden" value="<?php echo $section; ?>">
