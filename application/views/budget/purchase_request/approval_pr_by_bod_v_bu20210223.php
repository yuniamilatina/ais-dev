                        ...
                        <div style=" font-size: 11px;">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width='15%' align='right'></td>
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Budget Plan FY <?php echo $tahun - 1; ?></td>
                                    <td width='2%' align='center'>:</td>
                                    <td width='17%' align='right' style="font-weight: bold;">
                                        Rp <?php 
                                                echo number_format($total_budget_plant_fy_before->TOT_BUDGET_PLANT, 2, ',', '.') . ' (100,0%)';     
                                            ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Realisasi FY <?php echo $tahun - 1; ?></td>
                                    <td width='2%' align='center'>:</td>
                                    <td width='17%' align='right' style="font-weight: bold;">
                                        Rp <?php 
                                                if($total_budget_plant_fy_before->TOT_BUDGET_PLANT > 0){
                                                    $percent_real_fy = $total_real_plant_fy_before->TOT_REAL_PLANT / $total_budget_plant_fy_before->TOT_BUDGET_PLANT * 100;
                                                    $percent_real_fy = number_format($percent_real_fy, 2, ',', '.');
                                                    echo number_format($total_real_plant_fy_before->TOT_REAL_PLANT, 2, ',', '.') . ' ('.$percent_real_fy.'%)';
                                                } else {
                                ...
                                <tr>
                                    ...
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Budget Plan FY <?php echo $tahun; ?></td>
                                    <td width='2%' align='center'>:</td>
                                    <td width='17%' align='right' style="font-weight: bold;">
                                        Rp <?php 
                                                if($act_periode < $periode_smt2){
                                ...
                                <tr>
                                    ...
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Budget Rev FY <?php echo $tahun; ?></td>
                                    <td width='2%' align='center'>:</td>
                                    <td width='17%' align='right' style="font-weight: bold;">
                                        Rp <?php 
                                                if($act_periode < $periode_smt2){
                        ...
                        <div>
                            <table width='100%' style="font-size: 10px;">
                                ...
                                <tr>
                                    ...
                                    <td width='7%' align='right' >
                                        <?php 
                                            echo number_format($ytd_topup, 0, ',', '.');
                                        ?>
                                    </td>
                                    <td width='7%' align='right' >
                                        <?php 
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <iframe frameBorder="0" width='100%' height='300px' src="<?php echo site_url("budget/report_budget_c/view_detail_budget_gm/" . $tahun . "/" . $bgt_type . "/" . $kode_dept); ?>"></iframe>
                    </div>
                </div>
            </div>
        </div>
