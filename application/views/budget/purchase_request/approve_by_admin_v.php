                        ...
                        <table id="dataTables1" class="table table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    $total_plan = $this->capex_plan_m->get_total_capex_plan_by_admin($isi->INT_ID_FISCAL_YEAR);
                        ...
                        <table id="dataTables3" class="table table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data_pureq_detail as $isi) {
                                    ...
                                    ?>
                                <td>
                                    <a href="<?php echo base_url('index.php/budget/purchase_request_c/view_detail_by_supervisor') . "/" . $isi->INT_NO_PUREQ; ?>" class="label label-success" data-toggle="tooltip" data-placement="right" title="View"><span class="fa fa-check"></span></a>
...
<?php
foreach ($data as $row) {
    $total_plan_per_dept = $this->capex_plan_m->get_total_capex_plan_by_admin($row->INT_ID_FISCAL_YEAR);
    ?>
        {
