                                ...
                                <tr>
                                        ...
                                        if($detail_sales != NULL){
                                            ...
                                            if($kode_dept != NULL){
                                                if($revisi_budget_by_sales_dept != NULL && $bgt_type <> 'CONSU'){
                                                    ...
                                                    if($act_periode < $periode_smt2){
                                                        $total_budget_dept_guide = ($tot_salesrev*($ratio_sales->DEC_RATIO/100))*($total_all_budget_plan_dept->TOT_BGTPLAN/$total_budget_plant);
                                                    } else {
                                                        $total_budget_dept_guide = ($tot_salesrev*($ratio_sales->DEC_RATIO/100))*($total_all_budget_revisi_dept->TOT_BGTREV/$total_all_budget_revisi_plant);
                                                    }
                                                }                                                
                                            } else {
                                    ...
                                    <?php 
                                        if($bgt_type == 'CAPEX'){
                                            ...
                                            if($total_budget_dept_guide == NULL){ //BUDGET PLAN
                                                echo 'Rp ' . number_format(0, 2, ',', '.');
                                            } else {
                                    ...
                                    <?php                                    
                                        if($bgt_type == 'CAPEX'){
                                            ...
                                            if($total_budget_plant_guide == 0){
                                                ...
                                                if($total_real_group != NULL){
                                                    $percent_real = ($total_real_group->TOT_REAL_GROUP / $total_budget_plant_guide)*100;
                                                } else {
                                                    $percent_real = 0;
                                                }                                                
                                            } 
                                ...
                                <tr style=" border-top-style: solid;">  
                                    ...
                                    <?php
                                        if($bgt_type == 'CAPEX'){
                                            ...
                                            if($total_real_group != NULL){
                                                $saldo_group =  $total_budget_plant_guide - $total_real_group->TOT_REAL_GROUP;
                                            } else {
                                                $saldo_group =  $total_budget_plant_guide - 0;
                                            }
                                            
                                            if($total_budget_plant_guide == 0){
                                                $percent_saldo = 0;
                                            } else {
                                                $percent_saldo = ($saldo_group / $total_budget_plant_guide)*100;
                                            }
                                        }
                                    ...
                                    <?php
                                        ...
                                        if($bgt_type == 'CAPEX'){
                                            ...
                                            if($total_budget_plant_guide == 0){
                                                ...
                                                $percent_next_saldo = ($next_saldo_group / $total_budget_plant_guide)*100;
                                            }
                                        }
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <iframe frameBorder="0" width='100%' height='180px' src="<?php echo site_url("budget/report_budget_c/view_detail_budget_dept/" . $tahun . "/" . $bgt_type . "/" . $kode_dept); ?>"></iframe>
                    </div>
                </div>
            </div>
        </div>
