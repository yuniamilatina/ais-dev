            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>APPROVAL PURCHASE REQUEST - MANAGER</strong></span>
...
//                                                ?> > <?php echo $kode->CHR_KODE_TRANSAKSI; ?> </option>
                                    ...
                                    <td width="20%" align="center">                                        
                                        <a href="<?php echo base_url('index.php/budget/purchase_request_c/save_approved_pr_manager') . "/" . $tahun . '/' . $bgt_type . '/' . $status_bgt . '/' . $kode_transaksi; ?>" class="btn btn-primary" title="Approve this Purchase Request" style="width:90px;" <?php if($status_bgt == 1 || $kode_transaksi == NULL || $obsolete == 1){ echo "disabled"; } ?>>Approve</a>
                                        <a href="<?php echo base_url('index.php/budget/purchase_request_c/save_unapproved_pr_manager') . "/" . $tahun . '/' . $bgt_type . '/' . $status_bgt . '/' . $kode_transaksi; ?>" class="btn btn-danger" title="Unapprove this Purchase Request" style="width:90px;" <?php if($status_bgt == 0 || $kode_transaksi == NULL || $approve_gm == 1 || $approve_bod == 1){ echo "disabled"; } ?>>Unapprove</a>
                                    </td>                                  
                                </tr>                                                         
                            </table>
                        </div>
                        ...
                        <table id="dataTable" class="table table-striped table-condensed table-hover display" cellspacing="0" width="100%" border="1px">
                            <thead>
                                <tr style=" background-color: #002a80; color: white;">
                                    ...
                                    <?php } ?>                                    
                                    <td align='center' style="font-weight: bold;">Approved MAN</td>
                        ...
                        <div style=" font-size: 14px;">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width='1%'></td>
                                    <td colspan='3' width='35%'align='center' style="font-weight: bold;"><?php echo $dept_name; ?></td>
                                </tr>
                                <tr>
                                    <!-- RBG BASED ON SALES -->
                                    <?php 
                                    ...
                                    if($bgt_type <> 'CAPEX'){
                                        if($detail_sales != NULL){
                                            ...
                                            if($act_periode < $periode_smt2){
                                                ...
                                                $percent_from_total_plant = $tot_plan_rbg/$total_all_budget_revisi_plant;
                                            }
                                    ...
                                    <?php    
                                      if($bgt_type == 'CAPEX'){
                                        if($total_budget_plan->TOT_BGTPLAN == NULL){ //BUDGET PLAN
                                            echo 'Rp ' . number_format(0, 2, ',', '.');
                                        } else {
                                            echo 'Rp ' . number_format($total_budget_plan->TOT_BGTPLAN,2,',','.'); 
                                        }
                                      } else {
                                        if($total_budget_plant_guide == NULL){ //BUDGET PLAN
                                            echo 'Rp ' . number_format(0, 2, ',', '.');
                                        } else {
                                            echo 'Rp ' . number_format($total_budget_plant_guide,2,',','.'); 
                                        }
                                      }
                                    ...
                                    <?php 
                                      ...
                                      if($bgt_type == 'CAPEX'){
                                        ...
                                        $saldo_budget = $total_budget_plant_guide - $total_budget_real->TOT_BUDGET_REAL;
                                      }
                                    ...
                                    <td width='17%' align='right' style="font-weight: bold;">
                                        Rp <?php 
                                            if($bgt_type == 'CAPEX'){
                                                if($act_periode < $periode_smt2){
                                                    echo number_format($total_all_budget_plan->TOT_BGTPLAN, 2,',', '.') . ' (100,0 %)';
                                                } else {
                                                    echo number_format($total_all_budget_plan->TOT_BGTPLAN, 2,',', '.') . ' (---,- %)';
                                                }
                                            } else {
                                ...
                                <tr>  
                                    ...
                                    <td width='15%' align='right'>
                                    <?php 
                                      if($total_cip_plan->TOT_CIPPLAN == NULL){ //BUDGET PLAN
                                            echo 'Rp ' . number_format(0, 2, ',', '.');
                                      } else {
                                    ...
                                    <?php 
                                        if($bgt_type == 'CAPEX'){
                                            if($act_periode < $periode_smt2){ //--- BEFORE REVISION
                                                if($total_all_budget_plan->TOT_BGTPLAN == 0){
                                                    $percent_real = 0;
                                                } else {
                                                    if($total_all_realisasi != NULL){
                                                        $percent_real = ($total_all_realisasi->TOT_REAL_DEPT / $total_all_budget_plan->TOT_BGTPLAN)*100;
                                                    } else {
                                                        $percent_real = 0;
                                                    }                                                
                                                }
                                               ...
                                               if($total_all_budget_revisi->TOT_BGTREV == 0){
                                                    ...
                                                    if($total_all_realisasi != NULL){
                                                        $percent_real = ($total_all_realisasi->TOT_REAL_DEPT / $total_all_budget_revisi->TOT_BGTREV)*100;
                                                    } else {
                                                        $percent_real = 0;
                                                    }                                                
                                                } 
                                            ...
                                            if($total_budget_plant_guide == 0){
                                                ...
                                                if($total_all_realisasi != NULL){
                                                    $percent_real = ($total_all_realisasi->TOT_REAL_DEPT / $total_budget_plant_guide)*100;
                                                } else {
                                                    $percent_real = 0;
                                                }                                                
                                            } 
                                    ...
                                    ?>
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Realisasi Dept</td>
                                    <td width='2%' align='center'>:</td>
                                    <td width='17%' align='right' style="font-weight: bold;">Rp 
                                        <?php 
                                            if($total_all_realisasi != NULL){
                                                echo number_format($total_all_realisasi->TOT_REAL_DEPT, 2,',', '.') . ' (' . number_format($percent_real, 1, ',', '.') . '%)'; 
                                            } else {
                                ...
                                <tr style=" border-top-style: solid;">  
                                    ...
                                    <?php 
                                        ...
                                        if($bgt_type == 'CAPEX'){
                                            ...
                                            $total_plan = $total_budget_plant_guide + $total_unbudget_plan->TOT_UNBUDGET + $total_cip_plan->TOT_CIPPLAN;
                                        }                                        
                                    ...
                                    <td width='1%'></td>
                                    <td width='17%' align='right' style="font-weight: bold;">Total Saldo Dept</td>
                                    <td width='2%' align='center'>:</td>
                                    <?php
                                        if($bgt_type == 'CAPEX'){
                                            if($act_periode < $periode_smt2){ //--- BEFORE REVISION
                                                if($total_all_realisasi != NULL){
                                                    $total_saldo_dept =  $total_all_budget_plan->TOT_BGTPLAN - $total_all_realisasi->TOT_REAL_DEPT;
                                                } else {
                                                    $total_saldo_dept =  $total_all_budget_plan->TOT_BGTPLAN - 0;
                                                }
                                                
                                                if($total_all_budget_plan->TOT_BGTPLAN == 0){
                                                    $percent_saldo = 0;
                                                } else {
                                                    $percent_saldo = ($total_saldo_dept / $total_all_budget_plan->TOT_BGTPLAN)*100;
                                                }
                                            } else { //--- AFTER REVISION
                                                if($total_all_realisasi != NULL){
                                                    $total_saldo_dept =  $total_all_budget_revisi->TOT_BGTREV - $total_all_realisasi->TOT_REAL_DEPT;
                                                } else {
                                                    $total_saldo_dept =  $total_all_budget_revisi->TOT_BGTREV - 0;
                                                }
                                                
                                                if($total_all_budget_revisi->TOT_BGTREV == 0){
                                                    $percent_saldo = 0;
                                                } else {
                                                    $percent_saldo = ($total_saldo_dept / $total_all_budget_revisi->TOT_BGTREV)*100;
                                                }
                                            }
                                        } else {
                                            if($total_all_realisasi != NULL){
                                                $total_saldo_dept =  $total_budget_plant_guide - $total_all_realisasi->TOT_REAL_DEPT;
                                            } else {
                                                $total_saldo_dept =  $total_budget_plant_guide - 0;
                                            }
                                            
                                            if($total_budget_plant_guide == 0){
                                                $percent_saldo = 0;
                                            } else {
                                                $percent_saldo = ($total_saldo_dept / $total_budget_plant_guide)*100;
                                            }
                                        }
                                        
                                    ?>
                                    <td width='17%'  align='right' style="background-color: #FBEDC8; font-weight: bold;">Rp <?php echo number_format($total_saldo_dept, 2, ',', '.') . ' (' . number_format($percent_saldo, 1, ',', '.') . '%)'; ?></td>
                                </tr>
                                <tr>
                                    <td width='10%'></td>
                                    <td width='2%'></td>
                        ...
                        <div align="right">
                            ...
                            <?php } ?>
                                <a href="<?php echo base_url('index.php/budget/purchase_request_c/download_gr') . "/" . $tahun . '/' . $bgt_type . '/' . $kode_dept; ?>" class="btn btn-primary" title="View Detail GR" style="width:130px;" <?php if($kode_dept == ''){ echo 'disabled'; } else { echo 'disabled'; }?>>View Detail GR</a>
                        </div>
                                        ...
                                        <div class="modal-body">
                                            <table width="100%" style="font-size:11px; font-weight: bold;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->APR,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->MEI,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->JUN,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->JUL,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->AGU,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->SEP,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->OKT,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->NOV,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->DES,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->JAN,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($budget_by_no->FEB,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($budget_by_no->MAR,0,',','.'); ?></td>
                                                </tr>
                                                <tr>
                                                    <td width="4%" align="left">Actual</td>
                                                    <td width="1%" align="left">:</td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->APR,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->MEI,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->JUN,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->JUL,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->AGU,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->SEP,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->OKT,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->NOV,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->DES,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->JAN,0,',','.'); ?></td>
                                                    <td width="7%" align="center" style=" background-color: lightgray;"><?php echo number_format($actual_by_bgtno->FEB,0,',','.'); ?></td>
                                                    <td width="7%" align="center"><?php echo number_format($actual_by_bgtno->MAR,0,',','.'); ?></td>
                                                </tr>
                                            </table>
                                        </div>
...
<script>
    ...
    $(document).ready(function () {
        //===== Alert ======//
        var stat = <?php echo $alert; ?>;
        if(stat === 1){
            alert('WARNING...!!! \nGunakan budget dengan bijak, Rupiah sedang menurun. \n1 USD = 13.934,00 IDR \n1 JPY = 129,42 IDR');
        }
    });
