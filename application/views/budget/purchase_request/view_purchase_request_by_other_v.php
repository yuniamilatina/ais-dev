                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <table class="table table-condensed table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tr><td><strong>Month</strong></td><td><?php echo $data->INT_MONTH_REAL; ?></td></tr>
                    ...
                    <div class="grid-body">
                        <?php
                        echo anchor('budget/purchase_request_c/prepare_approve_purchase_request', 'Back', 'class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Back to manage"');
                        ?>
                    </div>
                </div>
            </div>
