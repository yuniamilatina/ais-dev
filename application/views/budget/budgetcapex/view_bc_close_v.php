...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/budget/capex_plan_c/') ?>">Manage Budget Capex</a></li>            
                ...
                <div class="grid top">
                    ...
                    <div class="grid-body">
                        <table class="table table-condensed table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tr><td align='right'><strong>No Budget</strong></td><td><?php echo $data->INT_NO_BUDGET_CPX; ?></td></tr>
                            <tr><td align='right'><strong>Category</strong></td><td><?php echo $data->CHR_BUDGET_CATEGORY . ' - ' . $data->CHR_BUDGET_CATEGORY_DESC; ?></td></tr>
                            <tr><td align='right'><strong>Sub Category</strong></td><td><?php echo $data->CHR_BUDGET_SUB_CATEGORY . ' - ' . $data->CHR_BUDGET_SUB_CATEGORY_DESC; ?></td></tr>
                            <tr><td align='right'><strong>Purpose</strong></td><td><?php echo $data->CHR_PURPOSE . ' - ' . $data->CHR_PURPOSE_DESC; ?></td></tr>
                            <tr><td align='right'><strong>Department</strong></td><td><?php echo $data->CHR_DEPT . ' - ' . $data->CHR_DEPT_DESC; ?></td></tr>
                            <tr><td align='right'><strong>Section</strong></td><td><?php echo $data->CHR_SECTION . ' - ' . $data->CHR_SECTION_DESC; ?></td></tr>
                            ...
                            <tr><td align='right'><strong>Price</strong></td><td><?php echo 'Rp ' . number_format($data->DEC_TOTAL, 0, '', '.'); ?></td></tr>
                    ...
                    <div class="grid-body">
                        <?php
                        echo anchor('budget/capex_plan_c', 'Back', 'class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Back to manage"');
                        ?>
                    </div>
                </div>
            </div>
