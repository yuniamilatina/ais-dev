            ...
            <div class="col-md-6">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <?php echo form_open('budget/capex_plan_temp_c/approve_capex_by_director', 'class="form-horizontal"');
                        ?>
                        ...
                        <div class="grid-body">
                            <div class="pull-right">
                                <div class="form-group">
                                    <div class="btn-group">
                                        <input name="INT_ID_FISCAL" value="<?php echo $this_fiscal_year ?>" type="hidden">
                                        <button type="submit" name="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Approve this budget" onclick="return confirm('Are you sure want to approve this budget?');"><i class="fa fa-thumbs-up"></i> Approve</button>
                                        <?php echo form_close(); ?>
                                    </div>
                                </div>
                            </div>                    
