    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <table class="table table-condensed table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tr><td><strong>No Budget</strong></td><td><?php echo $data->INT_NO_BUDGET_CPX_TEMP; ?></td></tr>
                ...
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <?php if ($session['ROLE'] == 1 || $session['ROLE'] == 2 || $session['ROLE'] == 6) { ?>
                            <div class="pull-right grid-tools">
                                <a data-toggle="modal" data-target="#modalProject" title="Add Project" data-placement="left"><i class="fa fa-plus"></i></a>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="grid-body">
            ...
            <div class="col-md-8">
                <div class="grid">
                    <div class="grid-header">
                        <span class="grid-title">DETAIL BUDGET</span>
                        <?php if ($session['ROLE'] == 1 || $session['ROLE'] == 2 || $session['ROLE'] == 6) { ?>
                            <div class="pull-right  grid-tools">
                    ...
                    <div class="grid-body">
                        <table id='' class="table table-condensed display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Revise</th>
                                    <th>Month</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input name="INT_REVISE" class="form-control" readonly="true" type="text" value="<?php echo $isi->INT_REVISE; ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">No Budget</label>
                                                <div class="col-sm-5">
                                                    <input name="INT_NO_BUDGET_CPX_TEMP" class="form-control" readonly="true" type="text" value="<?php echo $isi->INT_NO_BUDGET_CPX_TEMP; ?>">
                                                </div>
                                            </div>
