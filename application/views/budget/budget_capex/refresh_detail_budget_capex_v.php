        ...
        <div class="row">
                            ...
                            <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;text-align:center;">No Budget</th>
                                        <th style="vertical-align: middle;text-align:center;">Description</th>
                                        <th style="vertical-align: middle;text-align:center;">CIP</th>
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        foreach ($summary_capex as $value) {
                                        ?>
                                        <tr>
            ...
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><i> No Available Data Capital Expenditure</i></span>
                </div>
            </div>
            <?php } ?>            
        </div>
