...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="#"><strong>Edit Planning Capex</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open('budget/budget_capex_c/update_budget_capex', 'class="form-horizontal" name="f" id="form-id"');
        ?>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>EDIT PLANNING BUDGET CAPEX</strong></span>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-horizontal">
                                        <input name="CHR_NO_BUDGET" type="hidden" value="<?php echo $no_budget; ?>">
                                        ...
                                        <?php //if ($session['ROLE'] === 1 || $session['ROLE'] === 2) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="INT_ID_COST_CENTER" id="costcenter" class="form-control" style="width:300px">
                                                        <!--<option value="">-- Select Section First --</option>-->
                                                        <?php
                                                        foreach ($data_costcenter as $isi) {
                                                            ?>
                                                            <option value="<?php echo $isi->INT_ID_COST_CENTER; ?>"
                                                            <?php
                                                                if($costcenter == $isi->INT_ID_COST_CENTER){
                                                                    echo ' SELECTED';
                                                                }
                                                            ?>><?php echo $isi->CHR_COST_CENTER . ' - ' . $isi->CHR_COST_CENTER_DESC; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>  
                                ...
                                <div class="tab-pane" id="tab2">
                                    <div class="form-horizontal">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="CHR_BUDGET_CATEGORY" id="selectcategory" class="form-control" style="width:250px" required>
                                                    ...
                                                    foreach ($data_budgetcategory as $isi) {
                                                        ...
                                                        <?php
                                                            if($category == $isi->INT_ID_BUDGET_CATEGORY){
                                                                echo ' SELECTED';
                                                            }
                                            ...
                                            <div class="col-sm-5">
                                                <select name="CHR_BUDGET_SUB_CATEGORY" id="budgetsubcategory" class="form-control" style="width:300px" onchange="showOwner()" required>
                                                    ...
                                                    foreach ($data_budgetsubcategory as $isi) {
                                                        ?>
                                                        <option value="<?php echo $isi->INT_ID_BUDGET_SUB_CATEGORY; ?>"
                                                        <?php
                                                            if($subcategory == $isi->INT_ID_BUDGET_SUB_CATEGORY){
                                                                echo ' SELECTED';
                                                            }
                                                        ?>><?php echo $isi->CHR_BUDGET_SUB_CATEGORY . ' - ' . $isi->CHR_BUDGET_SUB_CATEGORY_DESC; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group" id="owner" style="display:none;">
                                            ...
                                            <div class="col-sm-3">
                                                <label class="radio-inline"><input type="radio" class="icheck" name="CHR_OWNER" value="Aisin" <?php if($owner == 'Aisin'){ echo 'checked';} ?>> Aisin</label>
                                                <label class="radio-inline"><input type="radio" class="icheck" name="CHR_OWNER" value="Customer" <?php if($owner == 'Customer'){ echo 'checked';} ?>> Customer</label>
                                            </div>
                ...
                <!--                            <label class="col-sm-2 control-label">Owner</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="CHR_PURPOSE" class="form-control" style="width:250px" id="budgetpurpose">
                                                    <!--<option value="">-- Select Purpose --</option>-->
                                                    <!--<option value="">-- Select Category First --</option>-->
                                                    <?php
                                                    foreach ($data_purposebudget as $isi) {
                                                        ?>
                                                        <option value="<?php echo $isi->CHR_PURPOSE; ?>"
                                                        <?php
                                                            if($purpose == $isi->CHR_PURPOSE){
                                                                echo ' SELECTED';
                                                            }
                                                        ?>><?php echo $isi->CHR_PURPOSE . ' - ' . $isi->CHR_PURPOSE_DESC; ?></option>
                                                        <?php
                                                    }
                                                    ?>                                     
                                                </select>
                                            ...
                                            <label class="col-sm-2 control-label" id="project" <?php if($category == 1){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?>>Project</label>
                                            <div class="col-sm-3" id="project2" <?php if($category == 1){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?>>
                                                <select name="CHR_PROJECT[]" multiple id="e1" class="form-control" style="width:300px">
                                                    <?php
                                                    foreach ($data_project as $isi) {
                                                        $code_proj = trim($isi->CHR_PROJECT);
                                                        $proj = $this->db->query("SELECT CHR_PROJECT FROM CPL.TT_BUDGET_CAPEX WHERE CHR_NO_BUDGET = '$no_budget' AND CHR_PROJECT LIKE '%$code_proj%'")->num_rows();
                                                        if($proj > 0){
                                                        ?>
                                                            <option selected="true" value="<?php echo $isi->CHR_PROJECT; ?>"><?php echo $isi->CHR_PROJECT . ' - ' . $isi->CHR_PROJECT_DESC; ?></option>
                                                        <?php
                                                        } else {
                                                        ?>
                ...
                <!--                            <label class="col-sm-2 control-label">Project</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-2 control-label" id="product" <?php if($category == 1){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?>>Product</label>
                                            <div class="col-sm-3" id="product2" <?php if($category == 1){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?>>
                                                <select name="CHR_PRODUCT[]" multiple id="e2" class="form-control" style="width:250px">
                                                    <?php
                                                    foreach ($data_product as $isi) {
                                                        $code_prod = trim($isi->CHR_PRODUCT);
                                                        $prod = $this->db->query("SELECT CHR_PRODUCT FROM CPL.TT_BUDGET_CAPEX WHERE CHR_NO_BUDGET = '$no_budget' AND CHR_PRODUCT LIKE '%$code_prod%'")->num_rows();
                                                        if($prod > 0){
                                                        ?>
                                                            <option selected="true" value="<?php echo $isi->CHR_PRODUCT; ?>"><?php echo $isi->CHR_PRODUCT . ' - ' . $isi->CHR_PRODUCT_DESC; ?></option>
                                                        <?php
                                                        } else {
                                                        ?>
                ...
                <!--                            <label class="col-sm-2 control-label">Product</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <label class="radio-inline"><input type="radio" name="INT_FLG_CIP" class="icheck" value=0 <?php if($cip == '0'){ echo 'checked';} ?>> Non-CIP</label>
                                                <label class="radio-inline"><input type="radio" name="INT_FLG_CIP" class="icheck" value=1 <?php if($cip == '1'){ echo 'checked';} ?>> CIP</label>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input name="CHR_BUDGET_DESC" class="form-control" maxlength="100" required type="text" style=" width:795px;" value="<?php echo $budget_desc; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">    
                                            <label class="col-sm-2 control-label">Supplier</label>
                                            <div class="col-sm-5">
                                                <label class="radio-inline"><input type="radio" name="CHR_SUPPLIER" class="icheck" value="Local" <?php if($supplier == 'Local'){ echo 'checked';} ?>> Local</label>
                                                <label class="radio-inline"><input type="radio" name="CHR_SUPPLIER" class="icheck" value="Import" <?php if($supplier == 'Import'){ echo 'checked';} ?>> Import</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">  
                                                <select name="CHR_UNIT" id="uom_input" class="form-control" style="width:160px">*
                                                    ...
                                                    foreach ($unit as $isi) {
                                                        ?>
                                                        <option value="<?php echo $isi->CHR_SATUAN; ?>"
                                                        <?php
                                                            if($satuan == $isi->CHR_SATUAN){
                                                                echo ' SELECTED';
                                                            }
                                                        ?>><?php echo $isi->CHR_SATUAN . ' - ' . $isi->CHR_SATUAN_DESC; ?></option>
                                                        <?php
                                                    }
                                                    ?> 
                                                </select>
                                            ...
                                            <div class="col-sm-2">
                                                <select name="CHR_DEPC_MONTH" class="form-control" style="width:160px">
                                                    <option value="01" <?php if($month_depc == '01'){ echo 'selected'; } ?>>January</option>
                                                    <option value="02" <?php if($month_depc == '02'){ echo 'selected'; } ?>>February</option>
                                                    <option value="03" <?php if($month_depc == '03'){ echo 'selected'; } ?>>March</option>
                                                    <option value="04" <?php if($month_depc == '04'){ echo 'selected'; } ?>>April</option>
                                                    <option value="05" <?php if($month_depc == '05'){ echo 'selected'; } ?>>May</option>
                                                    <option value="06" <?php if($month_depc == '06'){ echo 'selected'; } ?>>June</option>
                                                    <option value="07" <?php if($month_depc == '07'){ echo 'selected'; } ?>>July</option>
                                                    <option value="08" <?php if($month_depc == '08'){ echo 'selected'; } ?>>August</option>
                                                    <option value="09" <?php if($month_depc == '09'){ echo 'selected'; } ?>>September</option>
                                                    <option value="10" <?php if($month_depc == '10'){ echo 'selected'; } ?>>October</option>
                                                    <option value="11" <?php if($month_depc == '11'){ echo 'selected'; } ?>>November</option>
                                                    <option value="12" <?php if($month_depc == '12'){ echo 'selected'; } ?>>December</option>
                                                </select>
                                            </div>
                                            <!--<input name="CHR_DEPC_YEAR" class="form-control" required type="number" value="<?php echo $year_depc; ?>" maxlength="4" style="width:80px">-->
                                            <select name="CHR_DEPC_YEAR" class="form-control" style="width:80px" required>
                                                <?php for ($x = 0; $x <= 15; $x++) { ?>
                                                    <option value="<?php echo date("Y", strtotime("+$x year")); ?>" <?php
                                                    if ($year_depc == date("Y", strtotime("+$x year"))) {
                                                        echo 'SELECTED';
                                                    }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <select name="CHR_CURRENCY" class="form-control" style="width:160px" id="curr_input" onchange="cekValue();">                                    
                                                    ...
                                                    <option value="<?php echo $curr->INT_ID_CURRENCY; ?>"
                                                    <?php
                                                        if($id_curr == $curr->INT_ID_CURRENCY){
                                                            echo ' SELECTED';
                                                        }
                                                    ?>><?php echo $curr->CHR_CURRENCY . ' - ' . $curr->CHR_CURRENCY_DESC; ?></option>
                                                    <?php } ?>
                                                </select>                                
                                            </div>
                                            <input type="text" name="RATE_CURRENCY" class="form-control" id="rate_curr" value="<?php echo $rate; ?>" style="width:80px" readonly>
                                        </div>
                ...
                <!--                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_PRICE" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" onchange="cekValue();" class="form-control" id="money" required type="text" value="<?php echo number_format($price_ori,0,',','.'); ?>">
                                            </div>
                ...
                <!--                            <label class="col-sm-2 control-label">Qty <b class="mandatory">*</b></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_INKLARING" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" onchange="cekValue();"  class="form-control" id="inklaring" type="text" value="<?php echo number_format($inkla,0,',','.'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_ENGFEE" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" onchange="cekValue();"  class="form-control" id="engfee" type="text" value="<?php echo number_format($engfee,0,',','.'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_IMPORT_DUTY" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" onchange="cekValue();"  class="form-control" id="importduty" type="text" value="<?php echo number_format($impdut,0,',','.'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">    
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_TOTAL" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" class="form-control" id="tot_money" required type="text" value="<?php echo number_format($price_idr,0,',','.'); ?>" readonly style="font-weight:bold;">
                                            </div>
                                        </div>

                                        <input name="PRICE_PER_UNIT_ORI" id="PRICE_ORI" type="hidden" value="<?php echo $price_ori; ?>">
                                        <input name="PRICE_PER_UNIT_IDR" id="PRICE_IDR" type="hidden" value="<?php echo $price_idr; ?>">
                                        <input name="PRICE_INKLARING" id="PRICE_INK" type="hidden" value="<?php echo $inkla; ?>">
                                        <input name="PRICE_ENGFEE" id="PRICE_ENG" type="hidden" value="<?php echo $engfee; ?>">
                                        <input name="PRICE_IMPORT_DUTY" id="PRICE_IMP" type="hidden" value="<?php echo $impdut; ?>">
                                        <input name="TOT_PRICE_IDR" id="TOT_PRICE_IDR" type="hidden" value="<?php echo $tot_price; ?>">

                                        <div class="form-group">
                                            <div class="col-sm-5">
                                                <strong><i id="alert_amo" style="color:red; display:none;"><span class="fa fa-exclamation-triangle"></span> Price per unit (IDR) untuk Capex tidak boleh KURANG dari Rp 3.000.000,00 </i></strong>
                                            </div>                                
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_4" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_4" required type="text" value="<?php echo $qty04; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>MAY</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_5" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_5" required type="text" value="<?php echo $qty05; ?>">
                                            </div> 

                                            <label class="col-sm-1 control-label">Qty <strong>JUN</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_6" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_6" required type="text" value="<?php echo $qty06; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>JUL</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_7" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_7" required type="text" value="<?php echo $qty07; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>AUG</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_8" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_8" required type="text" value="<?php echo $qty08; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>SEP</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_9" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_9" required type="text" value="<?php echo $qty09; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_10" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_10" required type="text" value="<?php echo $qty10; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>NOV</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_11" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_11" required type="text" value="<?php echo $qty11; ?>">
                                            </div> 

                                            <label class="col-sm-1 control-label">Qty <strong>DEC</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_12" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_12" required type="text" value="<?php echo $qty12; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>JAN</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_13" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_13" required type="text" value="<?php echo $qty01; ?>">
                                            </div>

                                            <label class="col-sm-1 control-label">Qty <strong>FEB</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_14" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_14" required type="text" value="<?php echo $qty02; ?>">
                                            </div> 

                                            <label class="col-sm-1 control-label">Qty <strong>MAR</strong></label>
                                            <div class="col-sm-1">
                                                <input name="INT_QTY_15" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_15" required type="text" value="<?php echo $qty03; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="TOT_QTY_ALL" autocomplete="off" onkeyup="formatangka(this);" class="form-control" id="tot_qty_all" required type="text" value="<?php echo $tot_qty; ?>" readonly style="font-weight:bold; width:100px;">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-sm-5">
                                                <strong><i id="alert_qty" style="color:red; display:none;"><span class="fa fa-exclamation-triangle"></span> Total quantity tidak boleh 0 </i></strong>
                                            </div>                                
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="MON_TOTAL_ALL" autocomplete="off" onkeyup="formatangka(this);replaceChars(document.f.a.value);" class="form-control" id="tot_amount" required type="text" value="<?php echo number_format($tot_price,0,',','.'); ?>" readonly style="font-weight:bold;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-4 col-sm-5">
                                                <div class="btn-group">
                                                    <button type="submit" id="save" class="btn btn-primary"><i class="fa fa-check"></i> Update</button>
                                                    <?php
