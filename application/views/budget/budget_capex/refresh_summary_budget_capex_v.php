...
<aside >
    ...
    <section class="content">
        <div class="row">
            <?php if ($summary_capex_div <> null) { ?>
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><strong><i>Summary Capex by Division</i></strong></span>
                </div>
                <div class="grid">                    
                        ...
                        <div id="table-luar">
                            <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        foreach ($summary_capex_div as $value) {
                                        ?>
                                        <tr>
                                        ...
                                        ?>
                                    <?php 
                                        foreach ($summary_capex_total as $value) { ?>
                                        <tr>
            ...
            <?php } ?>
            <?php if ($summary_capex_group <> null) { ?>
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><strong><i>Summary Capex by Group Dept</i></strong></span>
                </div>
                <div class="grid">
                    <div class="grid-body" style="padding-top: 0px">
                        <div id="table-luar">
                            <table id="example2" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        foreach ($summary_capex_group as $value) {
                                        ?>
                                        <tr>
                                            <td style="vertical-align: middle;text-align:center;"><?php echo $no; ?></td>
            ...
            <?php } ?>
            <?php if ($summary_capex_dept <> null) { ?>
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><strong><i>Summary Capex by Dept</i></strong></span>
                </div>
                <div class="grid">
                    <div class="grid-body" style="padding-top: 0px">
                        <div id="table-luar">
                            <table id="example3" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        foreach ($summary_capex_dept as $value) {
                                        ?>
                                        <tr>
                                            <td style="vertical-align: middle;text-align:center;"><?php echo $no; ?></td>
