...
//                                    }
                            ...
                            <label class="col-sm-2 control-label" id="project" style="display:none;">Project</label>
...
<!--                            <label class="col-sm-2 control-label">Project</label>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label" id="product" style="display:none;">Product</label>
...
<!--                            <label class="col-sm-2 control-label">Product</label>
                        ...
                        <div class="form-group">
                            ...
                            <input name="CHR_DEPC_YEAR" class="form-control" required type="number" value="2017" maxlength="4" style="width:80px">
                        </div>
...
<!--                            <label class="col-sm-2 control-label">Qty <b class="mandatory">*</b></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input name="INT_QTY_4" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_4" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>MAY</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_5" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_5" required type="text" value="0">
                            </div> 
                            
                            <label class="col-sm-1 control-label">Qty <strong>JUN</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_6" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_6" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>JUL</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_7" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_7" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>AUG</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_8" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_8" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>SEP</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_9" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_9" required type="text" value="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input name="INT_QTY_10" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_10" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>NOV</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_11" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_11" required type="text" value="0">
                            </div> 
                            
                            <label class="col-sm-1 control-label">Qty <strong>DEC</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_12" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_12" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>JAN</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_13" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_13" required type="text" value="0">
                            </div>
                            
                            <label class="col-sm-1 control-label">Qty <strong>FEB</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_14" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_14" required type="text" value="0">
                            </div> 
                            
                            <label class="col-sm-1 control-label">Qty <strong>MAR</strong></label>
                            <div class="col-sm-1">
                                <input name="INT_QTY_15" autocomplete="off" onkeyup="angka(this);" onchange="cekValue();" class="form-control" id="qty_15" required type="text" value="0">
                            </div>
                        </div>
