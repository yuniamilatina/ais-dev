...
<aside class="right-side">
    ...
    <section class="content">
        <form method="post" action="<?php echo site_url("budget/purposebudget_c/save_propose_unbudget") ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
        <div class="row">
            <div class="col-md-6">
                <div class="grid">                    
                ...
                <div class="grid">                
                        ...
                        <div class="grid-body">
                            ...
                            <div align="right">
                                ...
                                <?php 
                                    echo anchor('budget/purposebudget_c/propose_budget_revision', 'Cancel', 'class="btn btn-default"');
                                ?>
...
<script>
    ...
    function getCategory(value) {
        $.ajax({
            async: false,
            type: "POST",
            url: "<?php echo site_url('budget/purposebudget_c/get_list_category'); ?>",
    ...
    function getSection(value) {
        if(value != ""){
            $.ajax({
                async: false,
                type: "POST",
                url: "<?php echo site_url('budget/purposebudget_c/get_list_section'); ?>",
