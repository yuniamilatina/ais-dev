...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function refreshTable() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_dimat_c/refresh_detail_table",
                type: "POST",
                dataType: 'json',
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/budget/budget_dimat_c/"') ?>">Approval Budget Direct Material</a></li>
            <li class="active"> <a href="#"><strong>Approval Budget Direct Material</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>APPROVAL BUDGET DIRECT MATERIAL</strong></span>
                    ...
                    <div class="grid-body">
                        <?php echo form_open_multipart('budget/budget_dimat_c/approve_budget_dimat', 'class="form-horizontal"');
                        ?>
            ...
            <div class="col-md-12" id="sum_table" style="display:none;">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>DETAIL DIRECT MATERIAL</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
