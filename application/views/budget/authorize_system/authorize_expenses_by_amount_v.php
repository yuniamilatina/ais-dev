...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>Authorized Expenses by Amount</strong></a></li>
        </ol>
    </section>

    <section class="content">
        <div class="form-group">
            <form name="authorized_system" action="authorized_amount" method="post" >
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        <i class="fa fa-th-large"></i>
                        <span class="grid-title"><strong> Authorized Expenses by Amount </strong></span>
                            ...
                            <table id="example" class="table table-bordered table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                                <thead>
                                    <tr class='gradeX'>
                                        ...
                                        <th style="vertical-align: middle; text-align: center">Transaction Menu</th>
                                        <?php
                                        $index = 1;
                                        $index_gm = 1;
                                ...
                                <tbody>
                                    ...
                                    if (count($trans_menu) > 0) {
                                        foreach ($trans_menu as $isi) {
                                                ...
                                                echo "<td style=text-align:center;>$isi->CHR_DESC_SUBMODUL</td>";
                                                $index = 1;
                                                $count_dept = count($all_dept);
                                                $index_gm = 1;
                                                $count_gm = count($all_gm);
                                                ...
                                                if ($index < ($count_dept+1)){
                                                    foreach($all_dept as $data){
                                                        ...
                                                        $dept_ori = $data->CHR_KODE_DEPARTMENT;
                                                        if ($dept == 'BD1'){
                                                            $dept = 'BOD001';
                                                        } else if ($dept == 'BD2'){
                                                            $dept = 'BOD002';
                                                        ...
                                                        ?>
                                                            <td style="text-align:center;"><input type="checkbox" class="icheck" id="checkbox" name="<?php echo $form_menu.$dept ?>" value="1"
                                                        <?php
...
<script>
                                            ...
                                            function uncheckedChk(){
                                                var not_checked = []
                                                $("input[type='checkbox'][name='authorized[]']:not(:checked)").each(function (){
