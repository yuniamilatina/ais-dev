        ...
        <div class="row">
                        ...
                        <div id="table-luar">
                            <table id="example" class="table table-condensed table-bordered table-striped table-hover display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                        $no = 1;
                                        foreach ($summary_nopin as $value) {
                                        ?>
                                        <tr>
                                        ...
                                        ?>
                                    <?php 
                                        foreach ($summary_nopin_total as $value) { ?>
                                        <tr>
            ...
            <div class="col-md-12">
                <div class="grid-header">
                    <span class="grid-title"><i> No Available Data Non Operating Income</i></span>
                </div>
            </div>
            <?php } ?>            
        </div>
