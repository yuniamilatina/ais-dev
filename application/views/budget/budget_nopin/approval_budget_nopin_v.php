...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function refreshTable() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_nopin_c/refresh_detail_table",
                type: "POST",
                dataType: 'json',
                data: {INT_ID_FISCAL_YEAR: fiscalYear, INT_DEPT: dept, INT_DIV: div, INT_GROUP:group},
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/budget/budget_nopin_c/"') ?>">Approval Budget Non Operating Income</a></li>
            <li class="active"> <a href="#"><strong>Approval Budget Non Operating Income</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>APPROVAL BUDGET NON OPERATING INCOME</strong></span>
                    ...
                    <div class="grid-body">
                        <?php echo form_open_multipart('budget/budget_nopin_c/approve_budget_nopin', 'class="form-horizontal"');
                        ?>
            ...
            <div class="col-md-12" id="sum_table" style="display:none;">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>DETAIL NON OPERATING INCOME</strong></span>
                        <div class="pull-right grid-tools">
                            <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                        </div>
                    </div>
