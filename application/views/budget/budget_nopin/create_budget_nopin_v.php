...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function refreshTable() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/budget/budget_nopin_c/refresh_table",
                type: "POST",
                dataType: 'json',
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/budget/budget_nopin_c/"') ?>">Manage Budget Non Operating Income</a></li>
            <li class="active"> <a href="#"><strong>Create Budget Non Operating Income</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE BUDGET NON OPERATING INCOME</strong></span>
                    ...
                    <div class="grid-body" style="padding-bottom: 0px;padding-top: 25px;">
                        <?php echo form_open_multipart('budget/budget_nopin_c/upload_budget_nopin', 'class="form-horizontal"');
                        ?>
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-sm-3">
                                <select name="INT_ID_BUDGET_TYPE" id="INT_ID_BUDGET_TYPE" required class="form-control" style="width:250px" readonly>
                                    <option value="<?php echo $INT_ID_BUDGET_TYPE; ?>" selected=""> Non Operating Income </option>                                    
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label">
                                <a class="btn btn-info" style="display:block;" id="download_template" href="<?php echo base_url("index.php/budget/budget_nopin_c/download_template") ?>">Non Operating Income.xls</a>
                            </label>

                            <label class="col-sm-3 control-label">Upload File</label>
                            <div class="col-sm-3">
                                <input type="file" name="upload_budget_nopin" class="form-control" id="import" size="20" value="">
                            </div>
                            <?php //===== FUNCTION FOR SHOW AND HIDE BUTTON UPLOAD
                                if ($role != 1 && $role !=2){
                                    $auth_upload = $this->db->query("SELECT INT_FLG_UPLOAD FROM CPL.TT_MAPPING_AUTHORIZE_UPLOAD WHERE INT_ID_DEPT = '$INT_DEPT' AND INT_ID_BUDGET_SUB_GROUP = '6' AND INT_FLG_DELETE = '0'"); //=== AUTHORIZE NON OPERATING INCOME 
