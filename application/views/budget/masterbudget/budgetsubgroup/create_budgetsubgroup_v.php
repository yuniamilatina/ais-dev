<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open('budget/budgetsubgroup_c/save_budgetsubgroup', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Subgroup Budget Initial</label>
                            <div class="col-sm-5">
                                <input name="CHR_BUDGET_SUBGROUP" autofocus="true" class="form-control" maxlength="5" required type="text" style="width: 80px;text-transform: uppercase;">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label">Subgroup Budget Description</label>
                            <div class="col-sm-5">
                                <input name="CHR_BUDGET_SUBGROUP_DESC" class="form-control" maxlength="50" required type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php echo anchor('budget/budgetsubgroup_c', 'Cancel', 'class="btn btn-default" data-placement="right" data-toggle="tooltip" title="Back to manage"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
