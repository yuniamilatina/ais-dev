            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        <i class="fa fa-usd"></i>
                        <span class="grid-title"><strong><?php echo $data->CHR_BUDGET_CATEGORY; ?></strong> BUDGET CATEGORY</span>
                    ...
                    <div class="grid-body">
                        ...
                        <?php echo anchor('budget/budgetcategory_c', 'Back', 'class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Back to manage"'); ?>
