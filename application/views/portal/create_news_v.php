<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open_multipart('portal/news_c/save_news', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE NEWS</strong></span>
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="CHR_NEWS_TITLE" class="form-control" maxlength="200" required type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Description News</label>
                            <div class="col-sm-5">
                                <textarea name="CHR_NEWS_DESC" class="form-control" required type="textarea" rows="4" cols="50"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
