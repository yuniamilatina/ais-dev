...
<html lang="en">
    ...
    <head>
        ...
        <script src="<?php echo base_url('assets/jquery-ui-1.10.4.custom.min.js'); ?>" type="text/javascript" charset="utf-8"></script>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown navbar-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="badge"><?php if (!empty($notification_total)) { echo $notification_total[0]->TOTAL ; } ?></span>
                            </a>
                            <ul class="dropdown-menu box notification">
                                <li><div class="up-arrow"></div></li>
                                <li>
                                    <p>You have <?php if (!empty($notification_total)) { echo $notification_total[0]->TOTAL ; } ?> new notifications</p>
                                </li>
                                
                                <?php if (!empty($notification)) { foreach ($notification as $notification_l): ?>
                                <li>
                                    <a href="<?php echo base_url('index.php/'.$notification_l->CHR_LINK) ?>" >
                                        <i class="fa fa-<?php echo $notification_l->CHR_ICON; ?>  text-blue"></i> <?php echo $notification_l->CHR_NOTIF_TITLE; ?><!--span class="time pull-right">5 mins</-->
                                    </a>
                                </li>
                                <?php endforeach;} ?>
                        ...
                        <li class="dropdown profile-menu">
                            ...
                            <ul class="dropdown-menu box profile">
                                ...
                                <li >
                                    ...
                                    $npk = $session['NPK'];
                                    ?>
                                    <a href="<?php echo base_url('index.php/basis/user_c/change_password_user/' . $npk); ?>"><i class="fa fa-wrench"></i>Change Password &nbsp;<span class='badge'>!</span></a>
                                </li>
                                <li>
