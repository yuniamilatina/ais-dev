                                    ...
                                    foreach ($function as $function_data) {
                                        ...
                                        if ($module_data->INT_ID_MODULE == $function_data->INT_ID_MODULE) {
                                            ...
                                            if ($total_notification_function) {
                                                if ($function_data->INT_ID_FUNCTION == 204 || $function_data->INT_ID_FUNCTION == 223 ||  $function_data->INT_ID_FUNCTION == 90 || $function_data->INT_ID_FUNCTION == 300 || $function_data->INT_ID_FUNCTION == 301 || $function_data->INT_ID_FUNCTION == 103 || $function_data->INT_ID_FUNCTION == 320 ||  $function_data->INT_ID_FUNCTION == 322 || $function_data->INT_ID_FUNCTION == 324 || $function_data->INT_ID_FUNCTION == 332 || $function_data->INT_ID_FUNCTION == 343) {
                                    ...
                                    foreach ($function as $function_data) {
                                        if ($module_data->INT_ID_MODULE == $function_data->INT_ID_MODULE) {
                                            ...
                                            if ($total_notification_function) {
                                                ...
                                                if ($function_data->INT_ID_FUNCTION == 204 || $function_data->INT_ID_FUNCTION == 223 ||  $function_data->INT_ID_FUNCTION == 67 || $function_data->INT_ID_FUNCTION == 90 || $function_data->INT_ID_FUNCTION == 300 || $function_data->INT_ID_FUNCTION == 301 || $function_data->INT_ID_FUNCTION == 103 || $function_data->INT_ID_FUNCTION == 320 ||  $function_data->INT_ID_FUNCTION == 322 || $function_data->INT_ID_FUNCTION == 324 || $function_data->INT_ID_FUNCTION == 332 || $function_data->INT_ID_FUNCTION == 343) {
