...
for ($x=0; $x < $jml  ; $x++) { 
// var_dump($backno[$x]);die();
	$p.= '<div id="kotak">
		<table id="table">
		
			<tr>
				<td colspan="2"id="kotak02 ">PT AISIN INDONESIA</td>
				<td colspan="3" rowspan="2" id="kotak02">PICKUP KANBAN<br></td>
				<td></td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td style = "margin-left-:10mm""text-align:center" colspan="3" rowspan="2"><br>&nbsp;&nbsp;&nbsp;&nbsp;<barcode type="C39" value="'.$nokanban[$x].' '.$type[$x].' '.$serial[$x].'" label="label" style="width:87mm; height:10mm; color: #000000; font-size: 2mm">&nbsp;</barcode></td>
				<td></td>
