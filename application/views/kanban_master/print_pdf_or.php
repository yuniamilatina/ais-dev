...
for ($x=0; $x < $printqty  ; $x++) { 
	...
	if($specialorder == true && $buildout == true){
		$specialorder = '- SO';
	}
	...
	$p.= '<div id="kotak">
		<table id="table">
			...
			<tr>
				...
				<td colspan="3" rowspan="2" id="kotak02">ORDER KANBAN' . $specialorder .' '. $buildout. ' <br></td>
				<td></td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td style = "margin-left:10mm;text-align:center" colspan="3" rowspan="2"><br>&nbsp;&nbsp;<barcode type="C39" value="' . $nokanban . ' ' . $kanbantype . ' ' . $serialno[$x] . '" label="label" style="width:87mm; height:10mm; color: #000000; font-size: 1mm"></barcode>&nbsp;</td>
				<td></td>
			...
			<tr>
				...
				<td></td>
				<td id="kotak13">J901<br> PT AISIN INDONESIA</td>
 ...
 if (($page % 4) == 0) {
        $p.= //<p class=smallbawah></p>
		 "<style = page-break-after:always></style>";
    } 
	elseif (($page % 4) == 1) {
