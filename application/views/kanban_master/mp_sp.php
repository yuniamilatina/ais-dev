	...
	$p.= '<div id="kotak">
		<table id="table">
			...
			<tr>
				...
				<td colspan="3" rowspan="2" id="kotak02">SUPPLYPARTS KANBAN<br></td>
				<td></td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td></td>
				<td id="kotak13">'.$all[$x]->CHR_WC_VENDOR.'<br>'.$all[$x]->CHR_SUPPLIER_NAME.'</td>
			...
			<tr>
				...
				<td>Sloc to:'.$all[$x]->CHR_SLOC_TO.'</td>
				<td></td>
			</tr>
...
$this->kb_pdf->Output('mass_print_supplyparts.pdf');