...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/raw_material/coil_used_c/'); ?>"><span><strong>Report Coil Used</strong></span></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>REPORT COIL USED</strong></span>
                    </div>
                    <div class="grid-body" >
                        <?php echo form_open('raw_material/coil_used_c/report_coil_used', 'class="form-horizontal"'); ?>
                            ...
                            <table id="example1" class="table table-condensed table-hover display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;" rowspan="2">Barcode</th>
                                        <th style="text-align: center;" colspan="3">Weight (KG)</th>
                                        <th style="text-align: center;" colspan="2" >Last Used</th>
                                        <th style="text-align: center;" rowspan="2">Part No Coil</th>
                                        <th style="text-align: center;" rowspan="2">Recovery</th>
                                        <th style="text-align: center;" rowspan="2">PDS</th>
                                        <th style="text-align: center;" rowspan="2">Serial</th>
                                        <th style="text-align: center;" rowspan="2">Batch</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_coil as $isi) {
                                        ...
                                        echo "<td style='text-align: left;background:whitesmoke;'>$isi->BARCODE</td>";
                                        echo "<td style='text-align: center;'>" . number_format($isi->INT_WEIGHT_TOTAL) . "</td>";
                                    if (number_format($isi->INT_WEIGHT) < 0){
                                        echo "<td style='text-align: center;background:#FF154C;color:#FFFFFF;'>" . number_format($isi->INT_WEIGHT) . "</td>";
                                        echo "<td style='text-align: center;background:#FF154C;color:#FFFFFF;'>" .  number_format($isi->INT_WEIGHT_TOTAL - $isi->INT_WEIGHT) . "</td>";

                                    }else{
                                        echo "<td style='text-align: center;background:#00FC9B;'>" . number_format($isi->INT_WEIGHT) . "</td>";
                                        echo "<td style='text-align: center;background:#00FC9B;'>" .  number_format($isi->INT_WEIGHT_TOTAL - $isi->INT_WEIGHT) . "</td>";
                                        ...
                                        echo "<td style='text-align: center;'>$isi->INT_RECOVERY</td>";
