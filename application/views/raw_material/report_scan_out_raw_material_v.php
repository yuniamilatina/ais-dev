...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>REPORT SCAN OUT RAW MATERIAL</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">SCAN OUT RAW MATERIAL</span>
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('raw_material/scan_out_c/index', 'class="form-horizontal"'); ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='td-fixed'><?php echo $data->CHR_BACK_NO ?></div>
                                                </td>
                                                <td><?php echo $data->CHR_PART_NAME; ?></td>
                                                <td>
                                                    <div class='td-fixed'><?php echo $data->CHR_SLOC_FROM; ?></div>
                                                </td>
                                                <td>
                                                    <div class='td-fixed'><?php echo $data->CHR_SLOC_TO; ?></div>
                                                </td>
                                                <td><?php echo $data->INT_QTY_PER_BOX; ?></td>
                                                <td><?php echo $data->INT_QTY_BOX; ?></td>
                                                <td><?php echo $data->INT_TOTAL_QTY; ?></td>
                                                <!-- <td><?php echo $data->CHR_USER; ?></td> -->
                                            <?PHP
                                            $no++;
                                        }
                                            ?>
