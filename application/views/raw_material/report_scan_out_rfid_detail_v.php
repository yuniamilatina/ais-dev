...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>REPORT SCAN OUT RFID RAW MATERIAL</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">SCAN OUT RFID RAW MATERIAL</span>
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('raw_material/scan_out_rfid_rm_c/print_report_scanout', 'class="form-horizontal"'); ?>
                                ...
                                <input type="hidden" name="id_scr" id="id_scr" value="<?php echo $id; ?>" >
                                <input type="hidden" name="date_scr" id="date_scr" value="<?php echo $date; ?>">
								<input type="hidden" name="time_scr" id="time_scr" value="<?php echo $time; ?>">
                            <?php echo form_close() ?>
                        </div><br/>
<!--                        <div class="pull">
                        ...
                        <table id="dataTables3" class="table table-condensed table-striped display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data_rm_sto_detail as $data) {
                                    ...
                                    <tr>
                                        <td><?php echo $no; ?></td>  
										<td style="text-align:left"><?php echo $data->CHR_SERIAL_NO; ?> <?php echo $data->CHR_BACK_NO ?> <?php echo sprintf("%04s",$data->CHR_WEIGHT); ?> <?php echo $data->CHR_DATE_RECEIVED ?> <?php echo $data->CHR_SCI_NO; ?> <?php echo $data->CHR_PDS_NO; ?></td>
