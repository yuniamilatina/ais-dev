...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>REPORT SCAN OUT PLASTIC SUMMARY RAW MATERIAL</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>SCAN OUT PLASTIC SUMMARY RAW MATERIAL</strong></span>
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            <?php echo form_open('raw_material/scan_out_plastic_c/summary', 'class="form-horizontal"'); ?> 
