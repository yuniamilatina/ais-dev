            ...
            <div id="slider" class="sl-slider-wrapper">
                ...
                <div class="sl-slider">
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        ...
                        <div class="slide-caption">
                            <div class="caption-content">
                                <h1 class="animated fadeInDown"><?php echo $room1; ?></h1>
                                <h3 class="animated fadeInDown" id="meeting_info1"><?php echo $data_room_desc1; ?></h3>
                                <span class="animated fadeInDown" id="meeting_time1"><?php echo $data_room_date1; ?></span>

                                <!-- BEGIN BASIC TABLE -->
                                <div id="data-table-room1">
                                    <?php if (count($data_room_next_reservation_table1) > 0) { ?>
                                        <div class="col-md-6" style="margin-left:340px;margin-right: auto;color: white;">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody id="nextRoomTable">
                                                            ...
                                                            foreach ($data_room_next_reservation_table1 as $value_room1) {
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                    <td><?php echo date("jS F, Y", strtotime($value_room1->CHR_DATE_FROM)); ?></td>
                                                                    <td><?php echo date("H:i", strtotime($value_room1->CHR_TIME_FROM)) . " - " . date("H:i", strtotime($value_room1->CHR_TIME_TO)); ?></td>
                                                                    <td><?php echo $value_room1->CHR_MEETING_DESC; ?></td>
                                                                    <td><?php echo $value_room1->CHR_MEETING_PIC; ?></td>
                                                                </tr>
                                                                <?php
                                                                $i++;
                                                            }
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        ...
                        <div class="slide-caption">
                            <div class="caption-content">
                                <h1 class="animated fadeInDown"><?php echo $room2; ?></h1>
                                <h3 class="animated fadeInDown" id="meeting_info2"><?php echo $data_room_desc2; ?></h3>
                                <span class="animated fadeInDown" id="meeting_time2"><?php echo $data_room_date2; ?></span>

                                <!-- BEGIN BASIC TABLE -->
                                <div id="data-table-room2">
                                    <?php if (count($data_room_next_reservation_table2) > 0) { ?>
                                        <div class="col-md-6" style="margin-left:340px;margin-right: auto;color: white;">
                                            <div class="grid no-border">
                                                <div class="grid-header">
                                                    <i class="fa fa-bookmark"></i>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody id="nextRoomTable">
                                                            ...
                                                            foreach ($data_room_next_reservation_table2 as $value_room2) {
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                    <td><?php echo date("jS F, Y", strtotime($value_room2->CHR_DATE_FROM)); ?></td>
                                                                    <td><?php echo date("H:i", strtotime($value_room2->CHR_TIME_FROM)) . " - " . date("H:i", strtotime($value_room2->CHR_TIME_TO)); ?></td>
                                                                    <td><?php echo $value_room2->CHR_MEETING_DESC; ?></td>
                                                                    <td><?php echo $value_room2->CHR_MEETING_PIC; ?></td>
                                                                </tr>
                                                                <?php
                                                                $i++;
                                                            }
        ...
        $(document).ready(function() {
            ...
            $("#img-side-menu").click(function() {
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "<?php echo site_url('room/room_meeting_display_c/updateAjax_guestroom'); ?>",
                    data: {idroom1: <?php echo "'$roomid1'" ?> ,idroom2: <?php echo "'$roomid2'" ?> },
                    success: function(data) {
                        $("#data-table-room1").html(data.data_table1);
                        $("#meeting_info1").html(data.data_room_desc1);
                        $("#meeting_time1").html(data.data_room_date1);
                        
                        $("#data-table-room2").html(data.data_table2);
                        $("#meeting_info2").html(data.data_room_desc2);
                        $("#meeting_time2").html(data.data_room_date2);
                    }
                });
