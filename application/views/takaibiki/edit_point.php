<script>
    $(document).ready(function() {
        ...
        $('#save-header').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('takaibiki/takaibiki_c/save_point'); ?>",
                data: "part_no=" + p_no + "&left=" + intXPosition + "&top=" + intYPosition,
                success: function(data) {
                    alert("Data Berhasil Dsimpan");
                    window.location.assign("http://192.168.0.231/AIS_PP/index.php/takaibiki/takaibiki_c/edit_point/<?php echo $back_no ?>");
                }
            });
        ...
        $('#cancel-header').click(function() {
            window.location.assign("http://192.168.0.231/AIS_PP/index.php/takaibiki/takaibiki_c");
...
//            
            ...
            $("#bg-big").append("<img id='point_rep' src='http://192.168.0.231/AIS_PP/assets/pis_images/red%20glossy.png' style='width:100px;height:100px;position:absolute;top: " + intYPosition + "px;left:" + intXPosition + "px;'>");
    ...
    foreach ($pointer as $value_pointer) {
        ...
        ?>
                $("#img-point-<?php echo $cek_no ?>").click(function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('takaibiki/takaibiki_c/delete_point'); ?>",
...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li> <a href="#"><strong>EDIT PART TAKAIBIKI </strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-2">
                <div class="grid">
                    <div class="grid-header">
                        <span class="grid-title" id="stat-create2"><strong id="stat-create">RESULT</strong></span>
                    ...
                    <div class="grid-body">
                        <form role="form" action="<?php echo site_url('takaibiki/takaibiki_c/new_entry') ?>" class="form-horizontal">
                            ...
                            <div class="form-group" id="btn-group-header" style="float:none">
                                <div class="col-sm-offset-2 col-sm-12" style="margin:20px 0 0 10px ;">
                                    <div class="btn-group">
            ...
            <div class="col-md-10">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title" id="stat-create2"><strong id="stat-create">EDIT POINT CEK  <?php echo $back_no ?></strong></span>
                        <div class="pull-right grid-tools">
                            <div id="btn-publish" style="display:none;" type="submit" class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Publish ECI"><i class="fa fa-upload"></i> Publish</div>
                            <div id="published" style="display:none;background-color:#42CA51;border-color:#FFFFFF" class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Published"> Published</div>
                            <a href="<?php echo site_url("eci/schedule_c/list_eci") ?>"><div id="back-to-list" style="display:none;background-color:#42CA51;border-color:#FFFFFF" class="btn btn-danger" data-placement="right" data-toggle="tooltip" title="Published"> Published</div></a>
                    ...
                    <div class="grid-body" style="text-align:center;margin-left: auto;margin-right: auto;">
                        ...
                        <div id="bg-big" style="width:940px;height:600px;background-image: url('http://192.168.0.231/AIS_PP/assets/pis_images/<?php echo trim($back_no).'.JPG?id='.rand(10, 1000) ?>');background-size: 940px 600px;background-repeat: no-repeat;margin: 0px 0px 0px 0px;position:relative;" >
                            <?php
                            if (count($pointer) > 0) {
                                foreach ($pointer as $value_pointer) {
                                    $left = $value_pointer->width;
