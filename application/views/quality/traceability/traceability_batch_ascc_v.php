                        ...
                        <table id="dataTables3" class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;" colspan="26">Tester Value</th>           
                                ...
                                <tr>
                                    ...
                                    <!-- TESTER VALUE -->                                    
                                    <th style="text-align:center;">UPP FIN POINT</th>     
                                    <th style="text-align:center;">RES FIN POINT</th>                                    
                                    <th style="text-align:center;">LOW FIN POINT</th> 
                                    <th style="text-align:center;">UPP AMN MIG</th>                                   
                                    <th style="text-align:center;">RES AMN MIG 1</th>
                                    <th style="text-align:center;">RES AMN MIG 2</th>
                                    <th style="text-align:center;">RES AMN MIG 3</th>                                   
                                    <th style="text-align:center;">LOW AMN MIG</th>
                                    <th style="text-align:center;">UPP AMN TRANS</th>
                                    <th style="text-align:center;">RES AMN TRANS</th>                                   
                                    <th style="text-align:center;">LOW AMN TRANS</th>
                                    <th style="text-align:center;">UPP GOING WEAR</th>
                                    <th style="text-align:center;">RES GOING WEAR</th>     
                                    <th style="text-align:center;">LOW GOING WEAR</th>                                    
                                    <th style="text-align:center;">UPP GOING SET</th>
                                    <th style="text-align:center;">RES GOING SET</th>     
                                    <th style="text-align:center;">LOW GOING SET</th>                                    
                                    <th style="text-align:center;">UPP RETURN WEAR</th>
                                    <th style="text-align:center;">RES RETURN WEAR</th>     
                                    <th style="text-align:center;">LOW RETURN WEAR</th>                                    
                                    <th style="text-align:center;">UPP RETURN SET</th>
                                    <th style="text-align:center;">RES RETURN SET</th>     
                                    <th style="text-align:center;">LOW RETURN SET</th>                                    
                                    <th style="text-align:center;">UPP HYSTERIS</th>
                                    <th style="text-align:center;">RES HYSTERIS</th>
                                    <th style="text-align:center;">LOW HYSTERIS</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    ...
                                    foreach($data as $val){ 
                                        ...
                                        //=== DATA TESTER
                                        echo "<td>" . number_format($val->CHR_UPP_FIN_POINT/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_FIN_POINT/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_FIN_POINT/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_AMN_MIG/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_AMN_MIG_1/100,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_AMN_MIG_2/100,1,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_RESULT_AMN_MIG_3/100,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_AMN_MIG/100,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_AMN_TRANS/100,1,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_RESULT_AMN_TRANS/100,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_AMN_TRANS/100,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_GOING_WEAR/1,0,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_RESULT_GOING_WEAR/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_GOING_WEAR/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_GOING_SET/1,0,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_RESULT_GOING_SET/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_GOING_SET/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_RETURN_WEAR/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_RETURN_WEAR/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_RETURN_WEAR/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_RETURN_SET/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_RETURN_SET/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_RETURN_SET/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_UPP_HYSTERIS/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_RESULT_HYSTERIS/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_HYSTERIS/1,0,',','.') . "</td>";
                                        ...
                                        if($val->CHR_DATE_DELIVERY != NULL && $val->CHR_DATE_DELIVERY != ""){
