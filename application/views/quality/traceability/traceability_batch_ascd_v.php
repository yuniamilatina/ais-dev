                        ...
                        <table id="dataTables3" class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;" colspan="24">Tester Value</th>                                                                                                           
                                ...
                                <tr>
                                    ...
                                    <!-- TESTER VALUE -->
                                    <th style="text-align:center;">LO K1 UPP</th>     
                                    <th style="text-align:center;">LO K1</th>                                    
                                    <th style="text-align:center;">LO K1 LOW</th> 
                                    <th style="text-align:center;">LO H1 UPP</th>                                   
                                    <th style="text-align:center;">LO H1</th>
                                    <th style="text-align:center;">LO H1 LOW</th>
                                    <th style="text-align:center;">HI H1 UPP</th>                                   
                                    <th style="text-align:center;">HI H1</th>
                                    <th style="text-align:center;">HI H1 LOW</th>
                                    <th style="text-align:center;">HI H2 UPP</th>                                   
                                    <th style="text-align:center;">HI H2</th>
                                    <th style="text-align:center;">HI H2 LOW</th>
                                    <th style="text-align:center;">HI K1 UPP</th>     
                                    <th style="text-align:center;">HI K1</th>                                    
                                    <th style="text-align:center;">HI K1 LOW</th>
                                    <th style="text-align:center;">HI K2 UPP</th>     
                                    <th style="text-align:center;">HI K2</th>                                    
                                    <th style="text-align:center;">HI K2 LOW</th>
                                    <th style="text-align:center;">HI K3 UPP</th>     
                                    <th style="text-align:center;">HI K3</th>                                    
                                    <th style="text-align:center;">HI K3 LOW</th>
                                    <th style="text-align:center;">HI K4 UPP</th>     
                                    <th style="text-align:center;">HI K4</th>                                    
                                    <th style="text-align:center;">HI K4 LOW</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    ...
                                    foreach($data as $val){ 
                                        ...
                                        //=== DATA TESTER
                                        echo "<td>" . number_format($val->CHR_LOW_K1_UPP/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_K1/100,2,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_K1_LOW/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_H1_UPP/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_H1/100,2,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_LOW_H1_LOW/10,1,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_HIGH_H1_UPP/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_H1/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_H1_LOW/10,1,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_HIGH_H2_UPP/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_H2/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_H2_LOW/10,1,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_HIGH_K1_UPP/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K1/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K1_LOW/1,0,',','.') . "</td>"; 
                                        echo "<td>" . number_format($val->CHR_HIGH_K2_UPP/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K2/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K2_LOW/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K3_UPP/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K3/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K3_LOW/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K4_UPP/1,0,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K4/10,1,',','.') . "</td>";
                                        echo "<td>" . number_format($val->CHR_HIGH_K4_LOW/1,0,',','.') . "</td>";  
                                        ...
                                        if($val->CHR_DATE_DELIVERY != NULL && $val->CHR_DATE_DELIVERY != ""){
                                            echo "<td>" . substr($val->CHR_DATE_DELIVERY,0,4) . "/" . substr($val->CHR_DATE_DELIVERY,4,2) . "/" . substr($val->CHR_DATE_DELIVERY,6,2) . "</td>";
                                        } else {
                                            echo "<td>-</td>";
                                        }
