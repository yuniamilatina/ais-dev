                    ...
                    <div class="grid-body">
                        ...
                        <table width="100%">
                           <tbody>
                                   ...
                                   <tr>
                                   <td style="width: 33%;">
                                   			 <a href="<?php echo site_url('pes/product_entry_c/work_order/')?>">  
                                   ...
                                   <td style="width: 33%;"> <a href="<?php echo site_url('pes/promasdat_c/form/'.date('Ymd').'/1/'.$first_wcenter.'/0'.'/0'); ?>">   
                                           <div style="text-align:center" ><img src="<?php echo base_url() . "assets/img/Customer-Master-Database.png" ?>" alt="Master Data Production Execution" width="200" height="200"></div>
                                           <div style="text-align:center" >Master Data Production Execution</div></a></td>
                                    <td style="width: 33%;"> <a href="<?php echo site_url('pes/tranrmwho_c/form/'.date('Ymd').'/1/'.$first_wcenter.'/0'); ?>">   
                                           <div style="text-align:center" ><img src="<?php echo base_url() . "assets/img/transaction.png" ?>" alt="Transaksi Raw Material" width="200" height="200"></div>
                                           <div style="text-align:center" >Transaksi Raw Material Execution</div></a></td>
                                   </tr>
                                   <?php }else{ ?>
                                   
                                   <td style="width: 33%;"> <a href="<?php echo site_url('pes/prodentry_c/form/'.date('Ymd').'/1/'.trim($first_wcenter).'/0'); ?>">   
                                           <div style="text-align:center" ><img src="<?php echo base_url() . "assets/img/box.png" ?>" alt="Production Entry" width="200" height="200"></div>
                                           <div style="text-align:center" >Production Entry</div></a></td>
                                   <td style="width: 33%;"> <a href="<?php echo site_url('pes/prodentry_c/report/'.date('Ym')); ?>"  >   
                                           <div style="text-align:center" ><img src="<?php echo base_url() . "assets/img/report.png" ?>" alt="Production NG Report" width="200" height="200"></div>
