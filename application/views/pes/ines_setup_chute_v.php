...
<body id="body" data-baseurl="<?php echo base_url(); ?>">
    <section>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="text-align:center;width:33%;color:#FFF;">
                        INES <?php echo strtoupper($work_center) ?>
                    </td>
        ...
        <iframe id='setup-chute' src="http://localhost:8080/ines" height="155px" width="100%" style="border:none;bottom: 40px; position: fixed;"></iframe>
    ...
    <div class="popup" data-popup="modalDetailOneWayLabel">
        <div class="popup-inner">
            <div class="modal-header">
                <div class="label-modal">Serial - One Way Kanban (Error Only)
                </div>
            </div>
            <div class="modal-body">
    ...
    <div class="popup" data-popup="modalErrorMessage" id="modalErrorMessage">
        <div class="popup-inner">
            ...
            <div class="modal-footer">
                <button type="button" data-popup-close="modalErrorMessage" class="button-cancel">Close</button>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/ines/ines.setupchute.js') ?>"></script>
