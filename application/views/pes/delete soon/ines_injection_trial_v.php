...
<html>
    ...
    <body id="body" data-baseurl="<?php echo base_url(); ?>"> <!--style='cursor:none;'-->
        <section>
            <div id="header">
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_injection_trial.js"></script>
