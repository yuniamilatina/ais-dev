...
<html>
    ...
    <body id="body" data-baseurl="<?php echo base_url(); ?>">
        <section>
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style="text-align:center;width:33%;">
                                INES ASSEMBLY <?php echo strtoupper($work_center) ?>
                        </td>
            ...
            <span style="color:#2CF793;font-family: sans-serif;">Patch 2.8 - MQTT</span> <!-- versi 20-12-2018 -->
        </section>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_assy_trial.js"></script>
