...
<html>
        ...
        <section>
            ...
            <table style="width:100%;">
                    <tr>
                        ...
                        <td style="text-align:center;width:33%;">
                                INES PACKING <?php echo strtoupper($work_center) ?>
                        </td>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td colspan="6"><div class="label-material" id="qty-kanban"></div>
            ...
            <div class="bottom-right-summary">
                <ul>
                    <li style="color:#00FC9B;">
                        <span style="color:white;" id="total-pershift">TOTAL OK : 0 /Pcs</span>
                    </li>
                    <li style="color:#FF3539;">
                        <span style="color:white;" id="total-ng">TOTAL NG : 0 /Pcs</span>
                    </li>
                    <li style="color:#0097F4;">
                        <span style="color:white;" id="total-dandori">TOTAL DANDORI : 0</span>
                    </li>
                </ul>
            </div>
                ...
                <div class="modal-body">
                    <table class="modal-table">
                        <tr>
                            ...
                            <input type="text" class="input-modal-qwerty" placeholder='NPK' maxlength="6" onkeyup="countChar(this)" id="start-box" />
       ...
       <div class="popup" data-popup="modalDandori">
            <div class="popup-inner">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" placeholder="Scan kanban" class="input-modal" id="barcode-value" />
        ...
        <div class="popup" data-popup="modalTotalKanban">
            <div class="popup-inner">
                ...
                <div class="modal-body">
                    <input type="text" class="input-modal numeric" id="totalkanban" maxlength="3" readonly />
                    <table class='keyboard'>
                        <tr>
                    ...
                    <div id="false-total" class="message">
                        <i class="message-error" id="msg-false-total"></i>
                    </div>
                </div>
                <div class="modal-footer">
        ...
        <div class="popup" data-popup="modalTotalMP">
            <div class="popup-inner">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="input-modal numeric" id="totalmp" maxlength="2" readonly />
                    <table class="keyboard">
                        <tr>
            ...
            <div class="popup-inner">
                ...
                <div class="modal-body">
                    <table class="modal-table">
                        <tr>
                            <td rowspan="2">
                                <input type="text" placeholder='Input Qty' maxlength="3" class="input-modal numeric" id="qty" />
                ...
                <div class="modal-body">
                    <table class="modal-table">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input-modal" maxlength="3" placeholder='Qty Eceran' onkeyup="countChar(this)" id="QtyEceran" />
                                <table class='keyboard'>
                                    <tr>
        ...
        <div class="popup" data-popup="modalLabel">
            <div class="popup-inner">
                <div class="modal-header">
                    <div class="label-modal">Customer label</div>
                </div>
                <div class="modal-body">
                    <div id="loading-scan-label" class="message">
                        <img src="<?php echo base_url() ?>assets/js/ines/loader.gif" />
                    </div>
                    <input type="text" class="input-modal" id="barcode-label" placeholder="Scan Label Customer"/>
                    ...
                    <div class="modal-footer">
                        <button type="button" data-popup-close="modalLabel" class="button-cancel">Close</button>
                    </div>
                </div>
            </div>
        </div>

        <div class="popup" data-popup="modalWI">
            <div class="popup-inner">
                <div class="modal-body">
                    <div id="loading-scan-label" class="message">
                        <img src="<?php echo base_url() ?>assets/js/ines/loader.gif" />
                    ...
                    <div class="modal-footer">
                        <button id="cancelWI" type="button" data-popup-close="modalWI" class="button-cancel">Close</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_spps_trial.js"></script>
