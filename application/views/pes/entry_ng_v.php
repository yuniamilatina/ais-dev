...
window.location.href= "<?php echo site_url()?>/pes/prodng_c/form/<?php echo $date_l; ?>/<?php echo $shift; ?>/<?php echo $wcenter_l; ?>/1";
</script>
...
<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>Production NG</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>PRODUCTION</strong> NG</span>
                                        ...
                                        <td width="150"  height="30" >Work Center</td><td>:</td><td>
                                                <select id="opt_wcenter" onChange="document.location.href=this.options[this.selectedIndex].value;">
                                                  <?php foreach($wcenters as $wcenter):?>
                                                          <option value="<? echo site_url('pes/prodng_c/form/'.$date_l.'/'.$shift.'/'.($wcenter->CHR_WCENTER_MN).'/'.$set); ?>" <?php if($wcenter_l == $wcenter->CHR_WCENTER_MN){echo 'SELECTED';} ?> ><? echo $wcenter->CHR_WCENTER_MN; ?></option>
                                                  <?php endforeach;?>
                                                          <option value="<? echo site_url('pes/prodng_c/form/'.$date_l.'/'.$shift.'/ALL/'.$set); ?>" <?php if($wcenter_l == 'ALL'){echo 'SELECTED';} ?> >ALL</option>
                                                </select>
                                        </td>
                                </tr>
                                <tr>
                                        ...
                                        <td colspan="5">
                                                <input type="submit" name="send" value="1" id="submit" style="height:40px;width:70px; <?php if($shift=='1'){echo 'background-color: #FBE5BC;';}else{echo 'background-color: #ADC9B7;';} ?>" onClick="location.href='<?php echo site_url('pes/prodng_c/form/'.$date_l.'/1/'.$wcenter_l.'/'.$set) ?>';">
                                                <input type="submit" name="send" value="2" id="submit" style="height:40px;width:70px; <?php if($shift=='2'){echo 'background-color: #FBE5BC;';}else{echo 'background-color: #ADC9B7;';} ?>" onClick="location.href='<?php echo site_url('pes/prodng_c/form/'.$date_l.'/2/'.$wcenter_l.'/'.$set) ?>';">
                                                <input type="submit" name="send" value="3" id="submit" style="height:40px;width:70px; <?php if($shift=='3'){echo 'background-color: #FBE5BC;';}else{echo 'background-color: #ADC9B7;';} ?>" onClick="location.href='<?php echo site_url('pes/prodng_c/form/'.$date_l.'/3/'.$wcenter_l.'/'.$set) ?>';">
                                                <input type="submit" name="send" value="4" id="submit" style="height:40px;width:70px; <?php if($shift=='4'){echo 'background-color: #FBE5BC;';}else{echo 'background-color: #ADC9B7;';} ?>" onClick="location.href='<?php echo site_url('pes/prodng_c/form/'.$date_l.'/4/'.$wcenter_l.'/'.$set) ?>';">
                                        </td>
                                </tr>
                        ...
                        <table class="table table-striped" id="list_data">
                                <thead>
                                        <tr>
                                                ...
                                                <th width="60px" rowspan="2" style="text-align:center;vertical-align:middle">NG</th>
                                ...
                                <tbody> 
                                        ...
                                        <tr style="background-color: #e7e7e7">
                                                ...
                                                <td><input style="text-align:right;padding-right:0px;width:60px;" type="text" size="1" name="tot_qty_NG" id="tot_qty_ok" value="" readonly="yes" ></td>
...
<script type="text/javascript">
	...
	function getLocation() {
		...
		if(<?php echo $set ?> ==0)
		{
		location.href='<?php echo site_url()?>/pes/prodng_c/form/' + date_fix + '/' + <?php echo $shift; ?> + '/' + t.options[t.selectedIndex].text + '/1'
		}else
		{
		location.href='<?php echo site_url()?>/pes/prodng_c/form/' + date_fix + '/' + <?php echo $shift; ?> + '/' + t.options[t.selectedIndex].text + '/0'
		}
	}
