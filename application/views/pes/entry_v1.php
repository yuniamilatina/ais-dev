...
<aside class="right-side">
            ...
            <div class="col-md-12" >
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">PRODUCTION ENTRY SYSTEM</span>
                    ...
                    <div> <table width="334" border="0">
                              <tr>
                                <td width="5%" >&nbsp;</td>
                                <td width="10%">Work Center</td>
                                <td width="15%"> : 
                                  <label for="i_workcent"></label><input type="text" name="i_workcent" id="i_workcenter" /></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>Shift</td>
                                <td>: 
                                  <label for="i_shift"></label><input type="text" name="i_shift" id="i_shift" /></td>
                              </tr>
                              </table>
	        </div>
            <br />
  ...
  <tr>
    ...
    <td width="100%"><form id="form1" name="form1" method="post" action="">
      <input type="submit" name="jam6" id="jam1" value="06.00-07.00" onclick="" />
      <input type="submit" name="jam7" id="jam2" value="07.00-08.00" />
      <input type="submit" name="jam8" id="jam3" value="08.00-09.00" />
      <input type="submit" name="jam9" id="jam4" value="09.00-10.00" />
      <input type="submit" name="jam10" id="jam5" value="10.00-11.00" />
      <input type="submit" name="jam11" id="jam6" value="11.00-12.00" />
      <input type="submit" name="jam12" id="jam7" value="12.00-13.00" />
      <input type="submit" name="jam13" id="jam8" value="13.00-14.00" />
      <input type="submit" name="jam14" id="jam9" value="14.00-15.00" />
      <input type="submit" name="jam15" id="jam10" value="15.00-16.00" />
      <input type="submit" name="jam16" id="jam11" value="16.00-17.00" />
      <input type="submit" name="jam17" id="jam12" value="17.00-18.00" />
      <input type="submit" name="jam18" id="jam13" value="18.00-19.00" />
      <input type="submit" name="jam19" id="jam14" value="19.00-20.00" />
      <input type="submit" name="jam20" id="jam15" value="20.00-21.00" />
      <input type="submit" name="jam21" id="jam16" value="21.00-22.00" />
      <input type="submit" name="jam22" id="jam17" value="22.00-23.00" />
      <input type="submit" name="jam23" id="jam18" value="23.00-24.00" />
      <input type="submit" name="jam00" id="jam19" value="00.00-01.00" />
      <input type="submit" name="jam01" id="jam20" value="01.00-02.00" />
      <input type="submit" name="jam02" id="jam21" value="02.00-03.00" />
      <input type="submit" name="jam03" id="jam22" value="03.00-04.00" />
      <input type="submit" name="jam04" id="jam23" value="04.00-05.00" />
      <input type="submit" name="jam05" id="jam24" value="05.00-06.00" />
    </form></td>
  </tr>
</table>
<br />
<table width="100%" border="0"  >
  <tr>
    ...
    <td>
        ...
        <input type="button" value="Un - Set" />
    </td>
  </tr>
  <tr height="2px"></tr>
  <tr>
    <td>Part Number</td>
    <td>: <input disabled="disabled" name="" type="text" /></td>
    <td>Type</td>
    <td>: <input disabled="disabled" name="" type="text" /></td>
  </tr>
  <tr height="2px"></tr>
...
<div style="width: 50%; float: left; "> <strong> Qty Produksi </strong> 
<br	 />
<table width="80%"  border="1" style="text-align: center;">
  <tr>
    <td width="65%">OK</td>
    <td width="20%"><input type="text" size="9" /></td>
    <td width="20%">PC</td>
  </tr>
</table>
<br />
...
<table width="80%" border="1" style="text-align: center;">
  ...
  <tr>
    <td><input name="" type="text" size="15" /></td>
    <td><input name="" type="text" size="16" /></td>
    <td><input name="" type="text" size="9" /></td>
    <td width="20%">PC</td>
  </tr>
  <tr>
    <td><input name="" type="text" size="15" /></td>
...
<table width="80%">
  <tr>
    <td width="65%">Total Qty Produksi</td>
    <td width="20%" style="border: 1px; text-align: center;"><input type="text" size="9" readonly="readonly"/></td>
    <td width="20%" style="border: 1px; text-align: center;">PC</td>
  </tr>
</table>
...
<table width="100%" border="1">
  ...
  <tr>
    <td>Tunggu Material</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Tidak ada Kanban</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Gemba / Cleaning (3S)</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Meeting Henkanten</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<table width="100%">
<tr>
                                        <td width="140"  height="30" >Back Number</td><td>:</td><td><input name="name" type="text" id="search_back_number" size="30" placeholder="Back Number" <?php if($defaultSearch!='back_number'){echo 'disabled="true"';} ?>></td>
                                        <td width="3%" rowspan="4"></td>
                                        <td width="10%">Tanggal</td><td  width="10">:</td>
                                        <td> <input type="text" id="datepicker" placeholder="DD/MM/YYYY" value="<?php echo $date;?>" <?php if($set==1){echo 'disabled="yes"';}else{echo '';} ?>> <input type="submit" style="height:40px;width:70px;" name="send" value="<?php if($set==1){echo 'Un-Set';}else{echo 'Set';} ?>" id="submit" class="<?php if($set==1){echo 'active';}else{echo 'button';} ?>" onClick="getLocation()"></td>
              </tr>
                                <tr>
                                        <td width="140" height="30" style="border-right:0px">Part Number</td><td width="10">:</td><td><input name="name" type="text" id="search_part_number" placeholder="Part Number" <?php if($defaultSearch!='part_number'){echo 'disabled="true"';} ?>></td>
                                ...
                                <tr>
                                        ...
                                        <td width="140"  height="30" >P. Name & Model</td><td>:</td><td><input name="name" type="text" id="search_part_name" size="40" placeholder="P. Name & Model" <?php if($defaultSearch!='part_name'){echo 'disabled="true"';} ?> ></td>
                                        <td>Shift</td>
                                </tr>
                                        <td colspan="4">
