        ...
        <div class="popup-inner">
            ...
            <div class="modal-body">
                ...
                <div id="false-scan-label" class="message">
                    <i class="message-error" id="msg-false-scan-label"></i>
                </div>
            </div>
            <div class="modal-footer">
        ...
        <div class="popup-inner">
            ...
            <div class="modal-body">
                ...
                <div id="false-scan-npk" class="message">
                    <i class="message-error" id="msg-false-scan-npk"></i>
                </div>
            </div>
            <div class="modal-footer">
                        ...
                        <td width=45%>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" disabled class='button-pop-ng'>-</button></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_ogawa_trial.js"></script>
