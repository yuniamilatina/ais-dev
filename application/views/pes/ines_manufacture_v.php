            ...
            <tr>
                <td colspan="2" rowspan="2" class="box">
                    ...
                    <div class="box-body-location middle-location">
                        <span class="label-side" id="location"></span>
                ...
                <td colspan="3">
                    <div class="label-material" id="qty-weight"></div>
                    <input type="hidden" id="input-qty-weight" />
                </td>
                <td class="bottom-box">
                    <input type="button" class="button" id="btnAddCoil" value="ADD COIL" />
                </td>
                <td class="bottom-box">
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_manufacture.js"></script>
