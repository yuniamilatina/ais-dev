<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"><strong>Create Cavity</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open('pes/cavity_c/save_cavity', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE PART CAVITY</strong></span>
                            ...
                            <div class="col-sm-4">
                                <select  name="CHR_PART_NO" id="e1" required class="form-control">
                                    <?php foreach ($data_part_no as $part_no) { ?>
                                        <option value="<?php echo $part_no->CHR_PART_NO; ?>"><?php echo trim($part_no->CHR_PART_NO); ?></option>
                                    <?php }
                                    ?> 
                                </select>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select  name="CHR_PART_NO_MATE" id="e2" required class="form-control">
                                    <?php foreach ($data_part_no_mate as $part_no_mate) { ?>
                                        <option value="<?php echo $part_no_mate->CHR_PART_NO; ?>"><?php echo trim($part_no_mate->CHR_PART_NO); ?></option>
                                    <?php }
                                    ?> 
                                </select>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <select  name="CHR_WORK_CENTER" id="part_no_mate" required class="form-control">
                                    <?php foreach ($data_work_center as $work_center) { ?>
                                        <option value="<?php echo $work_center->CHR_WORK_CENTER; ?>"><?php echo trim($work_center->CHR_WORK_CENTER); ?></option>
                                    <?php }
                                    ?> 
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <button style='display:none;' type='submit' id="btnTrueSubmit" >Save</button>
                                    <?php
