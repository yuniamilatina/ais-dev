...
<body id="body" data-baseurl="<?php echo base_url(); ?>">
    <section>
        ...
        <div id="loading-scan-center-button" style="display:none; width: 10%; position: fixed; bottom: 400px;left:670px;z-index:100;">
            <img src="<?php echo base_url('assets/img/loading2.gif'); ?>">
            <button type="button" class="button" id="btn-refresh">REFRESH</button>
        </div>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/js/ines/ines_assy.js"></script>
