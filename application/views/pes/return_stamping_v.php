...
$(window).keydown(function(event){
    ...
    $("#backno").focusout(function() {
        $.ajax({
                url: '<?= base_url() ?>index.php/pes/return_stamping_c/getUom',
...
// autocomplete
$('#backno').autocomplete({
    source: "<?php echo site_url('pes/return_stamping_c/search'); ?>",
    minLength:1 ,
});
}); //end document ready
</script>
                        ...
                        <div class="col-sm-12" style="width:100%; float: center">
                            <div class="row">
                                <div class="col-sm-2 col-sm-offset-10 box">
                                    <form method="post" action="<?= base_url() ?>index.php/pes/return_stamping_c/printData" onclick="return validatePrint()">
                            ...
                            <form id="test1" method="post" action="<?= base_url() ?>index.php/pes/return_stamping_c/addData/">
                            ...
                            <form method="post" action="<?= base_url() ?>index.php/pes/return_stamping_c/deleteData" onsubmit="return validateForm()">
                            ...
                            <form method="post" action="<?= base_url() ?>index.php/pes/return_stamping_c/saveData">
                                <div class="col-sm-2" style="width:auto">
...
<script>
        ...
        function validatePrint() {
            ...
            if(cekprint=='n'){
                ...
                window.location.href = "<?= base_url() ?>index.php/pes/return_stamping_c/printData";
            }
