...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""><strong>ENTRY DATA NG AFTER PROCESS</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>ENTRY DATA NG AFTER PROCESS</strong></span>
                        ...
                        <table width="100%" class="filter" border="0px">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    ...
                                    ?>" onClick="location.href = '<?php echo site_url('pes/ng_unbalance_c/form/' . $date_l . '/1/') ?>';">
                                    ...
                                    ?>" onClick="location.href = '<?php echo site_url('pes/ng_unbalance_c/form/' . $date_l . '/2/') ?>';">
                                    ...
                                    ?>" onClick="location.href = '<?php echo site_url('pes/ng_unbalance_c/form/' . $date_l . '/3/') ?>';">
                                    ...
                                    ?>" onClick="location.href = '<?php echo site_url('pes/ng_unbalance_c/form/' . $date_l . '/4/') ?>';">
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="grid-body">
                        ...
                        <table  width="100%" border="0px">
                            <tr>
                                <td >
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#modalDefault" data-placement="left" data-toggle="tooltip" 
                                            title="Add Unbalance" style="display:block;"><span class="fa fa-plus"></span> &nbsp;&nbsp; Add NG</button>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-condensed table-striped" id="list_data" >
                            <thead>
                                <tr>
                                    ...
                                    <th width="180px" rowspan="2" style="text-align:center;vertical-align:middle">Back Number </th>
                                    <th width="360px" rowspan="2" style="text-align:center;vertical-align:middle">P.Name & Model</th>
                                    <th width="80px" rowspan="2" style="text-align:center;vertical-align:middle">Date</th>
                                    <th width="100px" rowspan="2" style="text-align:center;vertical-align:middle">Qty NG(PC)</th>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <?php echo form_open('pes/ng_unbalance_c/save_unb', 'class="form-horizontal"'); ?>

                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Back No</label>
                                                <div class="col-sm-8">
                                                    <select id='e1' name='back_no' style="width:120px" >
                                                        <?php foreach ($back_no as $list) { ?>
                                                            <option name='back_no' value="<?php echo $list->CHR_BACK_NO ?>"><?php echo $list->CHR_BACK_NO; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Qty NG (PC)</label>
                                                <div class="col-sm-8">
                                                    <input type='text' placeholder='  PC' onkeyup="angka(this);" name='qty' required />
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <div class="btn-group">
                                                ...
                                                <button id="btn-ok" type="submit" class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Add To List" ><i class="fa fa-check"></i> Save</button>
                                                <?php echo form_close(); ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php foreach ($data_unbalance as $edit){ ?>
                            ...
                            <div class="modal-wrapper">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        </div>                                        <div class="modal-header bg-blue">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                                            <h4 class="modal-title" id="myModalLabel1"><strong>Edit Quantity Purging</strong></h4>
                                        </div>
                                        <div class="modal-body">
                                            <?php echo form_open('pes/ng_unbalance_c/update_unb', 'class="form-horizontal"'); ?>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Back No</label>
                                                <div class="col-sm-8">
                                                    <input type='text' readonly name='back_no' value="<?php echo $edit->CHR_BACK_NO ?>"></input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Qty NG (PC)</label>
                                                <div class="col-sm-8">
                                                    <input type='text' placeholder='  PC' onkeyup="angka(this);" value="<?php echo $edit->INT_QTY ?>" name='qty' />
                                                </div>
                                            </div>
                                            <input type='hidden' value='<?php echo $edit->INT_ID ?>' name='id_unb' />
                                            <input type='hidden' value='<?php echo $edit->CHR_PART_NO ?>' name='part_no' />
                                            <input type='hidden' value='<?php echo $edit->CHR_PART_NAME ?>' name='part_name' />
                                        ...
                                        <div class="modal-footer">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <button id="btn-ok" type="submit" class="btn btn-primary" data-placement="left" data-toggle="tooltip" title="Update" ><i class="fa fa-check"></i>Update</button>
                                                <?php echo form_close(); ?>
                                            </div>
                                        </div>
                                    </div>
...
<script>   
    function changeDate() {
        ...
        location.href = '<?php echo site_url() ?>/pes/ng_unbalance_c/form/' + date_fix + '/' + <?php echo $shift; ?>;
    }
