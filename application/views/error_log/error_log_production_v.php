<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="<?php echo base_url('index.php/error_log_c/error_production') ?>"><strong>Error Log Production</strong></a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title">ERROR <strong>LOG PRODUCTION</strong></span>
                        ...
                        <table id="dataTables1" class="table table-condensed table-hover display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $isi) {
                                    ...
                                    echo "<td>" . trim($isi->CHR_WO_NUMBER) . "</td>";
                                    echo "<td>" . trim($isi->CHR_DATE) . "</td>";
