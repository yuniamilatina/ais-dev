    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/pes/kanban_master/'); ?>">Slitting - Good Receipt</a></li>
             <li><a href="<?php echo base_url('index.php/pes/kanban_master/'); ?>">Good Receipt - Import (Upload)</a></li>

            <li><a href=""><strong>IMPORT SLITTING</strong></a></li>
        </ol>
    </section>
              ...
              <div class="grid-header" style="margin-">
               ...
               <table class="table table-striped">
              		<tr>
									<th>
                          <label>PIB No</label>
                          <input type="text" name="pibno" style="height:25px;"><br></th>
                          <th></th>
<th>
					<input type="submit" name="btn_save_post" value="Save/Post" id="submit" class="button" style="height:30px;width:100px;float:right;" ></th>
                    </tr>
                    </table>
