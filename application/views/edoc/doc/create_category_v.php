<aside class="right-side">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/edoc/doc_c/create_doc/NULL' . "/" . $data_id_pos) ?>"><span>Upload Doc</span></a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <form method="POST" action="<?php echo site_url("edoc/doc_c/save_category" . "/" . $data_id_pos) ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									<div class="btn-group">
										...
										<?php
										echo anchor('edoc/doc_c/create_doc/NULL' . "/" . $data_id_pos, 'Cancel', 'class="btn btn-default"');
										echo form_close();
										?>
									</div>
								</div>
