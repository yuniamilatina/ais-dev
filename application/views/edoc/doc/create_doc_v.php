                    ...
                    <div class="grid-body">
                        <form method="POST" action="<?php echo site_url("edoc/doc_c/save_doc" . "/" . $data_id_pos) ?>" class="form-horizontal" enctype="multipart/form-data" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<a href="<?php echo base_url('index.php/edoc/doc_c/create_category') . "/" . $data_id_pos ?>" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="New Category Document" style="height:35px;font-size:14px;width:100px;"><b>New</b></a>
								</div>
							</div>
