                ...
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <div class="pull-right">
							...
							<a href="<?php echo base_url('index.php/edoc/doc_c/create_doc/NULL') . "/" . $data_id_pos ?>" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="Upload New Doc" style="height:35px;font-size:14px;width:100px;"><i class="fa fa-upload"></i> <b>Upload</b></a>
						</div>
                    </div>
                    <div class="grid-body">
                        <div class="row">
							<?php
								...
								?>
									<div class="col-md-3">
										...
										<div class="btn-group">
											<a href="<?php echo base_url('index.php/edoc/doc_c/history') . "/" . $isi->INT_ID_POS . "/" . $isi->INT_ID_DOC ?>" class="btn btn-warning btn-sl" role="button"><strong>History</strong></a>
										</div>
									</div>
