                ...
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo base_url('index.php/edoc/doc_c/index/NULL' . "/" . $data_id_pos) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Back To List Doc" style="height:35px;font-size:14px;width:100px;"><i class="fa fa-arrow-left"></i> <b>Back</b></a>
                        </div>
                    </div>
                    <div class="grid-body">
                        <div class="row">
