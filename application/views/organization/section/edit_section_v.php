<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open('organization/section_c/update_section', 'class="form-horizontal"');
        ?> 
                ...
                <div class="grid">
                    ...
                    <div class="grid-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="INT_ID_DEPT" id="source" class="form-control" style="width:400px">
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="INT_ID_COST_CENTER" class="form-control" >
                                    <?php
