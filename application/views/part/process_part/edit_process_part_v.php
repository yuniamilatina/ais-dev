...
<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('index.php/part/process_part_c/"') ?>">Manage Cycle Time</a></li>
            <li class="active"> <a href="#"><strong>Edit Cycle Time</strong></a></li>
    </section>
    <section class="content">
        ...
        echo form_open('part/process_part_c/update_process_part', 'class="form-horizontal"');
        ?>
            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>EDIT CYCLE TIME</strong></span>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php
                                    echo anchor('part/process_part_c', 'Cancel', 'class="btn btn-default"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
...
function get_data_work_center(){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: 'json',
        url: "<?php echo site_url('part/direct_backflush_general_c/get_work_center_by_id_dept'); ?>",
        data:  {
