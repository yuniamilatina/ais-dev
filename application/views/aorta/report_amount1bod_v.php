...
foreach ($summary_ot_amount as $isi) {
    ...
    if ($row_plan == $row_plan_target) {
        $amount_actual .= '{label: "' . $isi->KD_DEPT . '", y:' . $isi->TOT_AMOUNT_OVERTIME . ', indexLabel:"' . round(number_format($isi->TOT_AMOUNT_OVERTIME / 1000, 0, ",", "."), 2) . '"}';
        $row_plan++;
    } else {
        $amount_actual .= '{label: "' . $isi->KD_DEPT . '", y:' . $isi->TOT_AMOUNT_OVERTIME . ', indexLabel:"' . round(number_format($isi->TOT_AMOUNT_OVERTIME / 1000, 0, ",", "."), 2) . '"},';
        $row_plan++;
...
?>
    ...
    <?php if (strtoupper($id_dept) == 'ALL' or strtoupper($id_dept) == 'PRD1' or strtoupper($id_dept) == 'PRD2' or strtoupper($id_dept) == 'PRD3' or strtoupper($id_dept) == 'PRD4') { ?>
            <div class="row">
                <div class="col-md-12">
    ...
    ?>
                    ...
                    <div class="grid">
                        <div class="grid-header">
                            ...
                            <span class="grid-title"><strong>OVERTIME PRODUCTION GROUP CHART</strong></span>
        ...
        <?php if (strtoupper($id_dept) == 'ALL' or strtoupper($id_dept) == 'ENG' or strtoupper($id_dept) == 'KZN' or strtoupper($id_dept) == 'MISY' or strtoupper($id_dept) == 'MSU' or strtoupper($id_dept) == 'PC' or strtoupper($id_dept) == 'PPIC' or strtoupper($id_dept) == 'QA' or strtoupper($id_dept) == 'QC') { ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="grid">
                        <div class="grid-header">
                            <i class="fa fa-bar-chart-o"></i>
                            <span class="grid-title"><strong>OVERTIME SUPPORTING GROUP CHART</strong></span>
                            <div class="pull-right grid-tools">
                                <a data-widget="collapse" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="grid-body">                            
                            <iframe scrolling="no" frameBorder="0" style="width:100%;min-height:400px;overflow:hidden;" width=100% height=100% src="<?php echo site_url("aorta/report_amount_c/amount_supporting/" . $selected_date . '/' . $id_dept . "/$id_section"); ?>"></iframe>
                        </div>                    
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid-body">
                        <div class="pull">
                            ...
                            <table width="100%" id='filter'>
                                    ...
                                    <td width="60%">
                                        <select class="ddl" id="tanggal" onChange="document.location.href = this.options[this.selectedIndex].value;">
                                            <?php for ($x = -5; $x <= 5; $x++) {  $y = $x * 28 ?>
                                                <option value="<?PHP echo site_url('aorta/report_amount_c/amount/' . date("Ym", strtotime("+$y day")) . "/$id_prod/ALL"); ?>" <?php
                                ...
                                <tr>
                                    ...
                                    <td width="60%">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php } ?>
                                                <option value="<?php echo site_url("aorta/report_amount_c/amount/" . $selected_date . "/ALL/ALL"); ?>">ALL</option>
                                                <?php foreach ($all_dept_prod as $row) { ?>
                                                    <option value="<?php echo site_url("aorta/report_amount_c/amount/" . $selected_date . '/' . trim($row->KODE) . "/ALL"); ?>" <?php
                                                    if ($id_dept == trim($row->KODE)) {
                                                        echo 'SELECTED';
                                                    }
                                                    ?> ><?php echo trim($row->NAMA_DEP); ?></option>
                                                <?php } ?>
                                            </select>
                                    </td>
                                ...
                                <?php //if (strtoupper($id_dept) <> 'ALL') { ?>
                                    <!--<tr>
                                        <td width="10%">Section</td>
                                        <td width="60%">
                                            <select id="opt_wcenter" onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl2">
                                                <option value="<?php //echo site_url('aorta/report_amount_c/amount/' . $selected_date . "/$id_dept/ALL") ?>">ALL</option>
                                                    <?php //foreach ($all_work_centers as $row) { ?>
                                                    <option value="<?php //echo site_url('aorta/report_amount_c/amount/' . $selected_date . "/$id_dept/$row->KODE"); ?>" 
                                                    <?php
