<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"><strong>Create New Employee</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open('aorta/master_employee_c/save_employee', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>CREATE</strong> NEW EMPLOYEE </span>
                    ...
                    <div class="grid-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="NPK" autofocus class="form-control" maxlength="6" required type="text" style="width: 80px;text-transform: uppercase;">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="NAME" class="form-control" required type="text" style="width: 400px;text-transform: uppercase;" value="">
                            </div> 
                        </div>
                            ...
                            <div class="col-sm-5">
                                <select name="SUBSECTION" id="subsection" class="form-control" style="width:400px">
                                    ...
                                    foreach ($data_subsect as $isi) {
                                        ?>
                                        <option value="<?php echo $isi->KODE; ?>"><?php echo $isi->KODE . ' - ' . $isi->NAMA_SUBSECT; ?></option>
                                        <?php
                                    }
                                    ?> 
                                </select>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php echo anchor('aorta/master_employee_c', 'Cancel', 'class="btn btn-default" data-placement="right" data-toggle="tooltip" title="Back to manage"');
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
