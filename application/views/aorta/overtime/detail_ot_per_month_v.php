        ...
        <table id='example' class="table table-condensed table-striped table-hover display" cellspacing="0" width="100%" style="font-size: 10px;">
            ...
            <tbody>
                ...
                <tr align="right">
                    ...
                    <?php
                        //Per QUARTER
                        $tot_Q1_saldo = ($detail_quota_plan->BLN04 - $detail_quota_used->BLN04) + ($detail_quota_plan->BLN05 - $detail_quota_used->BLN05) + ($detail_quota_plan->BLN06 - $detail_quota_used->BLN06);
                        $avg_Q1_saldo = $tot_Q1_saldo / 3;
                        $tot_Q2_saldo = ($detail_quota_plan->BLN07 - $detail_quota_used->BLN07) + ($detail_quota_plan->BLN08 - $detail_quota_used->BLN08) + ($detail_quota_plan->BLN09 - $detail_quota_used->BLN09);
                        $avg_Q2_saldo = $tot_Q2_saldo / 3;
                        $tot_Q3_saldo = ($detail_quota_plan->BLN10 - $detail_quota_used->BLN10) + ($detail_quota_plan->BLN11 - $detail_quota_used->BLN11) + ($detail_quota_plan->BLN12 - $detail_quota_used->BLN12);
                        $avg_Q3_saldo = $tot_Q3_saldo / 3;
                        $tot_Q4_saldo = ($detail_quota_plan->BLN13 - $detail_quota_used->BLN13) + ($detail_quota_plan->BLN14 - $detail_quota_used->BLN14) + ($detail_quota_plan->BLN15 - $detail_quota_used->BLN15);
                        ...
                        //Total 1FY
                        $tot_fy_saldo = ($detail_quota_plan->BLN04 - $detail_quota_used->BLN04) + ($detail_quota_plan->BLN05 - $detail_quota_used->BLN05) + ($detail_quota_plan->BLN06 - $detail_quota_used->BLN06) + 
                                ($detail_quota_plan->BLN07 - $detail_quota_used->BLN07) + ($detail_quota_plan->BLN08 - $detail_quota_used->BLN08) + ($detail_quota_plan->BLN09 - $detail_quota_used->BLN09) +
                                ($detail_quota_plan->BLN10 - $detail_quota_used->BLN10) + ($detail_quota_plan->BLN11 - $detail_quota_used->BLN11) + ($detail_quota_plan->BLN12 - $detail_quota_used->BLN12) + 
                                ($detail_quota_plan->BLN13 - $detail_quota_used->BLN13) + ($detail_quota_plan->BLN14 - $detail_quota_used->BLN14) + ($detail_quota_plan->BLN15 - $detail_quota_used->BLN15);
                        $avg_fy_saldo = $tot_fy_saldo / 12;
                    ?>
                    <td><?php echo number_format(($detail_quota_plan->BLN04 - $detail_quota_used->BLN04),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN05 - $detail_quota_used->BLN05),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN06 - $detail_quota_used->BLN06),0,',','.'); ?></td>
                        <td><strong><?php echo number_format($tot_Q1_saldo,0,',','.'); ?></strong></td>
                        <td><strong><?php echo number_format($avg_Q1_saldo,0,',','.'); ?></strong></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN07 - $detail_quota_used->BLN07),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN08 - $detail_quota_used->BLN08),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN09 - $detail_quota_used->BLN09),0,',','.'); ?></td>
                    ...
                    <td><?php echo number_format(($detail_quota_plan->BLN10 - $detail_quota_used->BLN10),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN11 - $detail_quota_used->BLN11),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN12 - $detail_quota_used->BLN12),0,',','.'); ?></td>
                        <td><strong><?php echo number_format($tot_Q3_saldo,0,',','.'); ?></strong></td>
                        <td><strong><?php echo number_format($avg_Q3_saldo,0,',','.'); ?></strong></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN13 - $detail_quota_used->BLN13),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN14 - $detail_quota_used->BLN14),0,',','.'); ?></td>
                    <td><?php echo number_format(($detail_quota_plan->BLN15 - $detail_quota_used->BLN15),0,',','.'); ?></td>
                ...
                <?php } if (count($detail_quota_budget) > 0) {
                ?>
                    <tr align="right">
