            ...
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>APPROVAL OVERTIME - SUPERVISOR</strong></span>
                    ...
                    <div class="grid-body">
                                    ...
                                    <td width="10%" style='text-align:left;' colspan="4">
                                        <select id="opt_wcenter" onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl">
                                            <?php foreach ($all_dept as $row) { ?>
                                                <option value="<? echo site_url('aorta/overtime_c/prepare_approve_ot_by_spv/' . $period . '/' . trim($row->CHR_DEPT) . '/' . $section); ?>" <?php
                                    ...
                                    <td width="10%" style='text-align:left;' colspan="4">
                                        <select id="opt_wcenter" onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl">
                                            <?php foreach ($all_section as $row) { ?>
                                                <option value="<? echo site_url('aorta/overtime_c/prepare_approve_ot_by_spv/' . $period . '/' . trim($dept) . '/' . $row->KODE); ?>" <?php
                        ...
                        <?php echo form_open('aorta/overtime_c/approve_all_overtime_by_spv', 'class="form-horizontal"'); ?>
                                    ...
                                    ?>
                                        <?php if ($dept == '-') {
                                            ...
                                            <td align='center'>
                                                ...
                                                if ($isi->CEK_SPV == '-') {
                                                    echo '-';
                                                } else if ($isi->CEK_SPV == 0 && $isi->CEK_KADEP == 0) {
                                                ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <?php echo form_open('aorta/overtime_c/approve_form_overtime_by_spv', 'class="form-horizontal"'); ?>
