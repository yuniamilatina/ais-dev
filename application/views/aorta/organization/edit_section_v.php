<aside class="right-side">
    ...
    <section class="content">
        ...
        echo form_open('aorta/master_data_c/update_section', 'class="form-horizontal"');
        ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                        <input name="SECTION" class="form-control" type="hidden" value="<?php echo $data->KODE; ?>">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">Section Description</label>
                            <div class="col-sm-5">
                                <input name="SECTION_DESC" class="form-control" maxlength="40" required type="text" value="<?php echo $data->NAMA_SECTION; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="SECTHEAD" id="secthead" class="form-control" style="width:200px">
                                    ...
                                    foreach ($data_secthead as $isi) {
                                        ...
                                        <?php
                                            if(trim($data->KASIE_NPK) == trim($isi->CHR_NPK)){
                                                echo ' selected';
                                            }
                            ...
                            <div class="col-sm-5">
                                <select name="DEPT" id="dept" class="form-control" style="width:200px">
                                    ...
                                    foreach ($data_dept as $isi) {
                                        ...
                                        <?php
                                            if(trim($data->KODE_DEP) == trim($isi->KODE)){
                                                echo ' selected';
                                            }
