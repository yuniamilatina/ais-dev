            ...
            <div class="col-md-12">
                <div class="grid">
                    ...
                    <div class="grid-body">
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                        <select class="ddl" id="tanggal" onChange="document.location.href = this.options[this.selectedIndex].value;">
                                            <?php for ($x = -24; $x <= 1; $x++) {
                                                $y = $x * 28 ?>
                                                <option value="<?php echo site_url('aorta/quota_employee_c/prepare_approve_quota_by_spv/' . date("Ym", strtotime("+$y day")) . '/' . $dept . '/' . $section); ?>" <?php
                                    ...
                                    <td width="10%" style='text-align:left;' colspan="4">
                                        <select onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl">
                                            ...
                                            <?php foreach ($all_dept as $row) { ?>
                                                <option value="<?php echo site_url('aorta/quota_employee_c/prepare_approve_quota_by_spv/' . $period . '/' . $row->CHR_DEPT . '/' . $section); ?>" <?php
                                    ...
                                    <td width="60%">
                                        <select onChange="document.location.href = this.options[this.selectedIndex].value;" class="ddl">
                                            <?php foreach ($all_section as $row) { ?>
                                                <option value="<? echo site_url('aorta/quota_employee_c/prepare_approve_quota_by_spv/' . $period . '/' . trim($dept) . '/' . $row->KODE); ?>" <?php
                        ...
                        <?php echo form_open('aorta/quota_employee_c/approve_all_quota_employee_by_spv', 'class="form-horizontal"'); ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <td style='text-align:center;'>
                                            ...
                                            <?php if ($isi->SPV_APPROVE == 0) { ?>
                                                <a href="<?php echo base_url('index.php/aorta/quota_employee_c/approve_quota_employee_by_spv') . "/" . $isi->ID_DOC . "/" . $dept . "/" . $section . "/" . $period; ?>" class="label label-primary" data-placement="left" data-toggle="tooltip" title="Approve" onclick="return confirm('Are you sure want to Approve this quota request with code : ' + <?php echo $isi->ID_DOC ?>);"><span class="fa fa-thumbs-up"></span></a>
                                            <?php } ?>
                                            <?php if ($isi->SPV_APPROVE == 1 && $isi->KADEP_APPROVE == 0 && $isi->GM_APPROVE == 0 && $isi->DIR_APPROVE == 0) { ?>
                                                <a href="<?php echo base_url('index.php/aorta/quota_employee_c/unapprove_quota_employee_by_spv') . "/" . $isi->ID_DOC . "/" . $dept . "/" . $section . "/" . $period; ?>" class="label label-danger" data-placement="left" data-toggle="tooltip" title="Unapprove" onclick="return confirm('Are you sure want to Reject this quota request with code : ' + <?php echo $isi->ID_DOC ?>);"><span class="fa fa-thumbs-down"></span></a>
                                            <?php } ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            ...
                                            <?php if ($isi->SPV_APPROVE == 0) { ?>
                                                <?php echo form_open('aorta/quota_employee_c/approve_form_quota_employee_by_spv', 'class="form-horizontal"'); ?>
                                            <?php } ?>
                                            <?php if ($isi->SPV_APPROVE == 1 && $isi->KADEP_APPROVE == 0 && $isi->GM_APPROVE == 0 && $isi->DIR_APPROVE == 0) { ?>
                                                <?php echo form_open('aorta/quota_employee_c/unapprove_form_quota_employee_by_spv', 'class="form-horizontal"'); ?>
                                            <?php } ?>
...
<script>
    ...
    function get_data_detail(qrno) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: "POST",
            url: "<?php echo site_url('aorta/quota_employee_c/view_detail_quota_employee_by_spv'); ?>",
            data: "qrno=" + qrno,
