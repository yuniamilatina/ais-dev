...
class history_m extends CI_Model {
    ...
    {
        $aortadb = $this->load->database("aorta", TRUE);
        return $aortadb->query("SELECT * FROM TT_LOG_HISTORY_BALANCING L INNER JOIN TM_KRY K ON K.NPK COLLATE Latin1_General_CI_AS = L.CHR_NPK COLLATE Latin1_General_CI_AS
