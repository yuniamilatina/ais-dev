...
class quota_employee_m extends CI_Model
{
    ...
    function check_duplicate_req_quota($npk, $period)
    {
        ...
        CASE 
        WHEN SPV_APPROVE = 1 AND KADEP_APPROVE = 0 AND GM_APPROVE = 0 AND DIR_APPROVE = 0 THEN 'Sudah disetujui Supervisor'
        WHEN SPV_APPROVE = 1 AND KADEP_APPROVE = 1 AND GM_APPROVE = 0 AND DIR_APPROVE = 0 THEN 'Sudah disetujui Manager'
        WHEN SPV_APPROVE = 1 AND KADEP_APPROVE = 1 AND GM_APPROVE = 1 AND DIR_APPROVE = 0 THEN 'Sudah disetujui GM'
    ...
    function get_data_request_quota_employee_by_dir($dept, $period)
    {
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT, 
                                  ...
                                  WHERE TAHUNBULAN = '$period' AND K.KD_DEPT = '$dept' AND Q.FLG_DELETE = 0
                                      AND (
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 AND Q.GM_APPROVE = 1 AND Q.DIR_APPROVE = 1 AND Q.FLG_FINISH_APPROVE = 1 
                                        OR 
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 AND Q.GM_APPROVE = 1 AND Q.DIR_APPROVE = 0 AND Q.FLG_FINISH_APPROVE = 0 
                                        OR 
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 AND Q.GM_APPROVE = 1 AND Q.DIR_APPROVE = 1 AND Q.FLG_FINISH_APPROVE = 0 
                                        ) 
    ...
    function get_data_request_quota_employee_by_gm($dept, $period)
    {
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,
                                  ...
                                  WHERE TAHUNBULAN = '$period' AND K.KD_DEPT = '$dept' AND Q.FLG_DELETE = 0
                                      AND (
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 AND Q.GM_APPROVE = 1 
                                        OR 
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 AND Q.GM_APPROVE = 0
                                        ) 
    ...
    function get_data_request_quota_employee_by_mgr($dept, $period)
    {
        ...
        return $aortadb->query("  SELECT Q.ID_DOC, Q.TAHUNBULAN, Q.TGL_DOC, K.KD_DEPT,
                                  ...
                                  WHERE TAHUNBULAN = '$period' AND K.KD_DEPT = '$dept' AND Q.FLG_DELETE = 0
                                      AND (
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 1 
                                        OR 
                                        Q.SPV_APPROVE = 1 AND Q.KADEP_APPROVE = 0 
                                        ) 
    ...
    function get_data_request_quota_employee_by_qrno_for_gm($qrno)
    {
        $aortadb = $this->load->database("aorta", TRUE);
    ...
    function get_data_quota_request_by_period_by_dir($period, $id_doc)
    {
        ...
        return $aortadb->query("SELECT 
                ...
                JAM_EDIT, SPV_APPROVE, OPER_SPV_APPROVE, TGL_SPV_APPROVE, JAM_SPV_APPROVE,KADEP_APPROVE, OPER_KADEP_APPROVE, TGL_KADEP_APPROVE, JAM_KADEP_APPROVE, GM_APPROVE, OPER_GM_APPROVE, TGL_GM_APPROVE, JAM_GM_APPROVE, DIR_APPROVE, OPER_DIR_APPROVE, TGL_DIR_APPROVE, 
    ...
    public function check_flg_approval_quota($qrno)
    {
        ...
        return $aortadb->query("SELECT TOP 1 1 FROM TT_QUOTA_HIS WHERE ID_DOC = '$qrno' AND FLG_DELETE = 0 AND SPV_APPROVE = 1")->result();
    }
}
