...
class activity_m extends CI_Model {
    ...
    function get_data_activity() {
        return $this->db->query("select INT_ID_ACTIVITY, UPPER(CHR_ACTIVITY_NAME) AS CHR_ACTIVITY_NAME, CHR_DEPT from TM_ECI_ACTIVITY WHERE INT_FLG_DEL = 1 order by CHR_ACTIVITY_NAME ASC")->result();
    }
