...
//    function get_all_reservation_by_date($date) {
//        $query = $this->db->query("SELECT RR.CHR_ID_RESERV, R.CHR_DESC, RR.CHR_MEETING_DESC, RR.CHR_MEETING_DEPT, RR.CHR_DATE_FROM, RR.CHR_DATE_TO,
//                                            RR.CHR_TIME_FROM, RR.CHR_TIME_TO
//                                    FROM  $this->table_reservation RR 
//                                    INNER JOIN $this->table_room R ON R.CHR_KODE_ROOM = RR.CHR_KODE_ROOM
//                                    WHERE BIT_FLG_DEL = 1
...
//        $query = $this->db->query("SELECT RR.CHR_ID_RESERV, R.CHR_DESC, RR.CHR_MEETING_DESC, RR.CHR_MEETING_DEPT, RR.CHR_DATE_FROM, RR.CHR_DATE_TO,
//                                            RR.CHR_TIME_FROM, RR.CHR_TIME_TO, CHR_MEETING_PIC
//                                    FROM  $this->table_reservation RR 
//                                    INNER JOIN $this->table_room R ON R.CHR_KODE_ROOM = RR.CHR_KODE_ROOM
...
//                                        and '$finish_date' < CHR_TIME_FROM and '$finish_time' >= CHR_TIME_TO
//                                        ");
//
//        if ($query->num_rows() > 0) {
//            return false;
