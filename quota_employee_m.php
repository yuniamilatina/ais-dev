...
class quota_employee_m extends CI_Model
{
    ...
    function check_duplicate_req_quota($npk, $period)
    {
        ...
        CASE 
        WHEN KADEP_APPROVE = 0 AND GM_APPROVE = 0 AND DIR_APPROVE = 0 THEN 'Sudah disetujui Supervisor'
    ...
    public function check_flg_approval_quota($qrno)
    {
        ...
        return $aortadb->query("SELECT TOP 1 1 FROM TT_QUOTA_HIS WHERE ID_DOC = '$qrno' AND FLG_DELETE = 0")->result();
    }
}
